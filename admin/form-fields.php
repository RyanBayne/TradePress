			...
			foreach ( $options as $value ) {
				...
				switch ( $value['type'] ) {
					...
					case 'checkbox':
						...
						<?php
						if ( $value['type'] == 'scopecheckbox' ) {
							echo wp_kses_post( TradePress_scopecheckbox_required_icon( $value['scope'] ) ); } // Icon HTML from helper function
						?>
						<?php
						if ( $value['type'] == 'scopecheckboxpublic' ) {
							echo wp_kses_post( TradePress_scopecheckboxpublic_required_icon( $value['scope'] ) ); } // Icon HTML from helper function
						?>
