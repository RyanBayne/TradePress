...
$symbols = array(
	...
	array(
		...
		'indicators'     => array(
			...
			'macd'            => array(
				'value'       => 0.87,
				'signal'      => 'neutral',
				'description' => 'MACD flat relative to signal line',
				'score'       => 50,
				'weight'      => 20,
			),
			'moving_averages' => array(
				'value'       => '50 SMA test',
				'signal'      => 'neutral',
				'description' => 'Price testing 50-day moving average',
				'score'       => 60,
				'weight'      => 30,
			),
			'volume'          => array(
	...
	array(
		...
		'indicators'     => array(
			'rsi'             => array(
				'value'       => 78.6,
				'signal'      => 'overbought',
				'description' => 'Potentially overbought',
				'score'       => 75,
				'weight'      => 25,
			),
			'macd'            => array(
				...
				'description' => 'MACD well above signal line',
				'score'       => 95,
				'weight'      => 20,
			),
			'moving_averages' => array(
				'value'       => '50 & 200 SMA support',
				'signal'      => 'strongly bullish',
				'description' => 'Price well above all major moving averages',
				'score'       => 98,
				'weight'      => 30,
			),
			'volume'          => array(
	...
	array(
		...
		'indicators'     => array(
			...
			'volume'          => array(
				'value'       => '+ 32% avg',
				'signal'      => 'neutral',
				'description' => 'Above average volume but selling pressure',
				'score'       => 60,
				'weight'      => 25,
			),
		),
	...
	array(
		...
		'indicators'     => array(
			...
			'moving_averages' => array(
				'value'       => 'Above all key MAs',
				'signal'      => 'bullish',
				'description' => 'Price above all key moving averages',
				'score'       => 90,
				'weight'      => 30,
			),
			'volume'          => array(
				'value'       => '+ 25% avg',
				'signal'      => 'bullish',
				'description' => 'Volume above average on up days',
				'score'       => 80,
				'weight'      => 25,
			),
		),
	...
	array(
		...
		'indicators'     => array(
			...
			'volume'          => array(
				'value'       => '+ 40% avg',
				'signal'      => 'bullish',
				'description' => 'Strong volume on breakout',
				'score'       => 85,
				'weight'      => 25,
			),
		),
	...
	array(
		...
		'indicators'     => array(
			...
			'macd'            => array(
				'value'       => 1.05,
				'signal'      => 'neutral',
				'description' => 'MACD slightly above signal line',
				'score'       => 70,
				'weight'      => 20,
			),
			'moving_averages' => array(
				'value'       => 'Above 50 & 200 SMAs',
				'signal'      => 'bullish',
				'description' => 'Price above major moving averages',
				'score'       => 85,
				'weight'      => 30,
			...
			'volume'          => array(
				'value'       => '+ 5% avg',
				'signal'      => 'neutral',
				'description' => 'Volume slightly above average',
				'score'       => 60,
				'weight'      => 25,
			),
		),
	...
	array(
		...
		'indicators'     => array(
			...
			'volume'          => array(
				'value'       => '+ 20% avg',
				'signal'      => 'bullish',
				'description' => 'Above average volume on up days',
				'score'       => 75,
				'weight'      => 25,
			),
		),
	...
	array(
		...
		'indicators'     => array(
			...
			'volume'          => array(
				'value'       => '+ 10% avg',
				'signal'      => 'neutral',
				'description' => 'Average volume characteristics',
				'score'       => 50,
				'weight'      => 25,
			),
		),
	...
	array(
		...
		'indicators'     => array(
			...
			'volume'          => array(
				'value'       => '+ 15% avg',
				'signal'      => 'neutral',
				'description' => 'Slightly above average volume',
				'score'       => 65,
				'weight'      => 25,
			),
		),
...
foreach ( $symbols as $symbol ) {
	if ( in_array( $symbol['symbol'], array( 'AAPL', 'MSFT', 'GOOGL', 'AMZN' ) ) ) {
		$symbol['portfolio_advice'] = getPortfolioAdvice( $symbol );
		$portfolioSymbols[]         = $symbol;
	}
	if ( in_array( $symbol['symbol'], array( 'NVDA', 'TSLA', 'AMD', 'META' ) ) ) {
		$symbol['day_trading_advice'] = getDayTradingAdvice( $symbol );
		$dayTradingSymbols[]          = $symbol;
	}
	if ( in_array( $symbol['symbol'], array( 'META', 'NVDA', 'TSLA', 'QCOM', 'INTC' ) ) ) {
...
<div class="recent-symbols-container">    
			...
			foreach ( $portfolioSymbols as $symbol ) :
				...
				<div class="symbol-card <?php echo esc_attr( strtolower( $symbol['recommendation'] ) ); ?>">
					<div class="symbol-header">
						...
						<div class="symbol-price-section">
							...
							<span class="symbol-change <?php echo $symbol['change'] >= 0 ? 'positive' : 'negative'; ?>">
								<?php
								echo $symbol['change'] >= 0 ? '+' : '';
								echo number_format( $symbol['change'], 2 );
								?>
																(
								<?php
								echo $symbol['change'] >= 0 ? '+' : '';
								echo number_format( $symbol['change_percent'], 2 );
								?>
								%)
							</span>
						</div>
					...
					<div class="symbol-score">
						<div class="score-circle" style="background: conic-gradient(#4CAF50 0% <?php echo (int) $weighted_percentage; ?>%, #f5f5f5 <?php echo (int) $weighted_percentage; ?>% 100%);">
	...
	<div class="trading-strategy-section day-trading-section">
		...
		<div class="symbols-grid">
			<?php
			foreach ( $dayTradingSymbols as $symbol ) :
				$weighted_percentage = round( ( $symbol['score'] / $symbol['max_score'] ) * 100 );
				?>
				<div class="symbol-card <?php echo esc_attr( strtolower( $symbol['recommendation'] ) ); ?>">
					<div class="symbol-header">
	...
	<div class="trading-strategy-section intraday-section">
		...
		<div class="symbols-grid">
			<?php
			foreach ( $intradaySymbols as $symbol ) :
				$weighted_percentage = round( ( $symbol['score'] / $symbol['max_score'] ) * 100 );
				?>
				<div class="symbol-card <?php echo esc_attr( strtolower( $symbol['recommendation'] ) ); ?>">
					<div class="symbol-header">
