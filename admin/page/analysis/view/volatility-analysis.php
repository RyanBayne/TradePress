...
function tradepress_volatility_analysis_tab_content() {
	...
	$demo_timeframe  = isset( $_GET['timeframe'] ) ? sanitize_text_field( wp_unslash( $_GET['timeframe'] ) ) : '30';
		...
		<div class="tradepress-research-results">
			<div class="tradepress-research-panels">
				...
				<div class="tradepress-panel">
					...
					<p><?php printf( esc_html__( 'Based on your %1$s account with %2$s%% risk per trade:', 'tradepress' ), '$' . number_format( $account_size ), $risk_percentage ); ?></p>
						...
						<div class="tradepress-metrics-grid columns-3">
							<div class="tradepress-metric-card">
								...
								<div class="tradepress-metric-description">
									...
									printf( esc_html__( 'Approx. %s shares', 'tradepress' ), round( $shares ) );
									?>
								</div>
							</div>
