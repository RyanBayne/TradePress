...
// Get API call logs
$logs = TradePress_API_Logging::get_api_calls(
	array(
		'service'   => $service,
		'status'    => $status,
		'date_from' => $date_from,
...
$total_count = TradePress_API_Logging::get_api_call_count(
	array(
		'service'   => $service,
		'status'    => $status,
		'date_from' => $date_from,
...
<div class="tradepress-debug-section">
	...
	<div class="tradepress-filter-form">
		<form method="get" action="">
			...
			<input type="hidden" name="tab" value="<?php echo isset( $_GET['tab'] ) ? esc_attr( wp_unslash( $_GET['tab'] ) ) : ''; ?>">
			...
			<div class="filter-controls">
				<div class="filter-row">
					...
					<div class="filter-actions">
						...
						<a href="?page=<?php echo isset( $_GET['page'] ) ? esc_attr( wp_unslash( $_GET['page'] ) ) : ''; ?>&tab=<?php echo isset( $_GET['tab'] ) ? esc_attr( wp_unslash( $_GET['tab'] ) ) : ''; ?>" class="button"><?php esc_html_e( 'Reset', 'tradepress' ); ?></a>
					</div>
				</div>
			</div>
		</form>
