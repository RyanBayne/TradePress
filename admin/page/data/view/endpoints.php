...
if ( ! class_exists( 'TradePress_ListTable_Endpoints' ) ) {
	require_once 'listtable-endpoints.php';
}

/**
 * TradePress_ListTable_Demo_BugNet usually showing ALL items without filter.
 *
...
class TradePress_DebugView_Endpoints extends TradePress_ListTable_Endpoints {
	...
	public function column_cb( $item ) {
		return sprintf(
			'<input type="checkbox" name="exampleitem[]" value="%s" />',
			$item['headerone']
		);
	}
