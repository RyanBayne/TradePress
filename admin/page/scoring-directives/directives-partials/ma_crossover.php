...
$directive = $all_directives['ma_crossover'];
?>
<div class="directive-section">
    ...
    <div class="section-content">
        ...
        <div class="directive-settings">
            ...
            <div class="setting-group">
                <label><?php esc_html_e('Fast MA Period:', 'tradepress'); ?></label>
                <div class="setting-control">
                    <input type="number" value="50" min="10" max="100">
                </div>
            </div>
            <div class="setting-group">
                <label><?php esc_html_e('Slow MA Period:', 'tradepress'); ?></label>
                <div class="setting-control">
                    <input type="number" value="200" min="100" max="300">
                </div>
            </div>
        </div>
    </div>
