...
$directive = $all_directives['volume'];
?>
    ...
    <div class="section-content">
        ...
        <div class="directive-settings">
            ...
            <div class="setting-group">
                ...
                <div class="setting-control">
                    <input type="number" value="1.5" min="1" max="5" step="0.1">
                    <p class="setting-description"><?php esc_html_e('Multiplier of average volume to trigger signal.', 'tradepress'); ?></p>
                </div>
            </div>
        </div>
    </div>
