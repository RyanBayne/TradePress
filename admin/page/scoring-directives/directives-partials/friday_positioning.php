...
$directive = $all_directives['friday_positioning'];
?>
        ...
        <div class="directive-settings">
            <div class="setting-group">
                ...
                <div class="setting-control">
                    <input type="number" name="friday_positioning_weight" value="<?php echo esc_attr($directive['weight'] ?? 12); ?>" min="0" max="50">
            ...
            <div class="setting-group">
                ...
                <div class="setting-control">
                    <input type="number" name="friday_positioning_lookback" value="10" min="4" max="20">
                    <span class="setting-help">Historical analysis period</span>
                </div>
            </div>
            <div class="setting-group">
                <label><?php esc_html_e('Positioning Weight:', 'tradepress'); ?></label>
                <div class="setting-control">
                    <input type="number" name="friday_positioning_positioning_weight" value="25" min="10" max="40">
                    <span class="setting-help">Friday performance impact</span>
                </div>
            </div>
            <div class="setting-group">
                <label><?php esc_html_e('Close Strength Weight:', 'tradepress'); ?></label>
                <div class="setting-control">
                    <input type="number" name="friday_positioning_close_strength_weight" value="20" min="5" max="30">
                    <span class="setting-help">Intraday close strength impact</span>
                </div>
            </div>
        </div>
