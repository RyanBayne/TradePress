        ...
        <div class="directive-settings">
            <div class="setting-group">
                ...
                <div class="setting-control">
                    <input type="number" value="<?php echo esc_attr($directive['weight'] ?? 25); ?>" min="0" max="100">
                </div>
            </div>
            <div class="setting-group">
                <label><?php esc_html_e('Fast Period:', 'tradepress'); ?></label>
                <div class="setting-control">
                    <input type="number" value="12" min="5" max="20">
                </div>
            </div>
            <div class="setting-group">
            ...
            <div class="setting-group">
                ...
                <div class="setting-control">
                    <input type="number" value="9" min="5" max="15">
                </div>
            </div>
        </div>
    </div>
