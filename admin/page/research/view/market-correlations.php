	...
	<div class="tradepress-correlations-container">
					...
					<div class="correlation-presets">
						...
						echo esc_url(
							add_query_arg(
								array(
									'base_symbol'     => 'SPY',
									'compare_symbols' => 'QQQ,DIA,IWM,GLD,TLT',
								)
							)
						);
						?>
									" class="preset-link"><?php esc_html_e( 'Major ETFs', 'tradepress' ); ?></a>
						<a href="
						<?php
						echo esc_url(
							add_query_arg(
								array(
									'base_symbol'     => 'SPY',
									'compare_symbols' => 'XLK,XLF,XLV,XLE,XLI,XLY,XLP,XLU,XLB,XLRE',
								)
							)
						);
						?>
									" class="preset-link"><?php esc_html_e( 'Sectors', 'tradepress' ); ?></a>
						<a href="
						<?php
						echo esc_url(
							add_query_arg(
								array(
									'base_symbol'     => 'SPY',
									'compare_symbols' => 'EEM,EFA,FXI,EWJ,EWG,EWU',
								)
							)
						);
						?>
									" class="preset-link"><?php esc_html_e( 'International', 'tradepress' ); ?></a>
						<a href="
						<?php
						echo esc_url(
							add_query_arg(
								array(
									'base_symbol'     => 'SPY',
									'compare_symbols' => 'GLD,SLV,USO,UNG,DBC',
								)
							)
						);
						?>
									" class="preset-link"><?php esc_html_e( 'Commodities', 'tradepress' ); ?></a>
					</div>
				</form>
			</div>
		</div>
		...
		<div class="tradepress-research-results">
			<div class="correlation-results">
				...
				<h3><?php printf( esc_html__( 'Correlation Results: %1$s vs. Others (%2$s)', 'tradepress' ), $base_symbol, tradepress_get_timeframe_label( $timeframe ) ); ?></h3>
					...
					<?php foreach ( $correlation_data as $symbol => $data ) : ?>
						<div class="correlation-row">
							...
							<div class="correlation-bar-cell">
								...
								?>
								<div class="correlation-bar <?php echo $corr_class; ?>" style="width: <?php echo (float) $corr_width; ?>%;">
