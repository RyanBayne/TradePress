...
<div class="wrap tradepress-social-settings">
	<?php if ( empty( $current_section ) ) : ?>
		<div class="social-platforms-settings">
			<div class="platform-cards">
				<?php
				foreach ( $social_platforms as $platform_id => $platform_name ) :
					...
					<div class="platform-card">
						...
						<a href="<?php echo esc_url( admin_url( 'admin.php?page=TradePress_social&tab=settings&section=' . $platform_id ) ); ?>" class="button button-primary">
	...
	<?php else : ?>
		...
		<div class="platform-specific-settings">
			<p>
				<a href="<?php echo esc_url( admin_url( 'admin.php?page=TradePress_social&tab=settings' ) ); ?>">
