...
if ( ! class_exists( 'TradePress_Admin_SocialPlatforms_Tabs' ) ) :
	...
	class TradePress_Admin_SocialPlatforms_Tabs {
		...
		public static function add_help_tabs() {
			...
			if ( ! $is_social_page && isset( $_GET['page'] ) && $_GET['page'] === 'tradepress_social' ) {
				$is_social_page = true;
			}
		...
		public static function discord_tab() {
			...
			if ( file_exists( __DIR__ . '/view/discord/discord.php' ) ) {
				include __DIR__ . '/view/discord/discord.php';
			} else {
		...
		public static function twitter_tab() {
			if ( file_exists( __DIR__ . '/view/twitter.php' ) ) {
				include __DIR__ . '/view/twitter.php';
			} else {
		...
		public static function stocktwits_tab() {
			if ( file_exists( __DIR__ . '/view/stocktwits.php' ) ) {
				include __DIR__ . '/view/stocktwits.php';
			} else {
		...
		public static function stock_vip_tab() {
			...
			$parser_file = __DIR__ . '/view/discord/stockvip/class-tradepress-discord-stock-vip-parser.php';
			...
			$stock_vip_view = __DIR__ . '/view/discord/stockvip/view.stock-vip.php';
		...
		public static function settings_tab() {
			...
			if ( isset( $_POST['save_social_provider'] ) && isset( $_POST['_wpnonce'] ) && wp_verify_nonce( $_POST['_wpnonce'], 'tradepress-social-settings-provider' ) ) {
				...
				if ( $service == 'twitter' && isset( $_POST[ 'api_' . $service . '_token_secret' ] ) ) {
					update_option(
						'TradePress_social_' . $service . '_token_secret',
				...
				do_action(
					'TradePress_social_platform_update_' . $service,
					$service,
				...
				wp_safe_redirect(
					add_query_arg(
						...
						admin_url( 'admin.php?page=tradepress_social' )
					)
				);
				exit;
			}
			...
			$settings_file = __DIR__ . '/view/sp-settings.php';
		...
		public static function platform_switches_tab() {
			...
			$switches_file = __DIR__ . '/view/platform_switches.php';
