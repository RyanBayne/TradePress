    ...
    public static function output() {
        ...
        <div class="tradepress-diagrams-container">
            <div class="diagrams-header">
                <h2><?php esc_html_e('TradePress System Diagrams', 'tradepress'); ?></h2>
                <p><?php esc_html_e('Interactive visual diagrams showing data flow, system architecture, and algorithm processes.', 'tradepress'); ?></p>
            </div>
            
            <div class="diagram-controls">
                <select id="diagram-selector" class="regular-text">
                    <optgroup label="System Architecture">
                        <option value="api-management-flow"><?php esc_html_e('API Management Flow', 'tradepress'); ?></option>
                        <option value="api-usage-tracking"><?php esc_html_e('API Usage Tracking & Fallback System', 'tradepress'); ?></option>
                        <option value="api-data-standardization"><?php esc_html_e('API Data Standardization Flow', 'tradepress'); ?></option>
                        <option value="bugnet-logging"><?php esc_html_e('BugNet Logging System', 'tradepress'); ?></option>
                        <option value="data-flow"><?php esc_html_e('Data Flow Architecture', 'tradepress'); ?></option>
                        <option value="trading-platform-integration"><?php esc_html_e('Trading Platform Integration', 'tradepress'); ?></option>
                        <option value="database-schema"><?php esc_html_e('Database Schema Relationships', 'tradepress'); ?></option>
                        <option value="plugin-dependencies"><?php esc_html_e('Plugin Module Dependencies', 'tradepress'); ?></option>
                    </optgroup>
                    <optgroup label="Process Flows">
                        <option value="api-testing-workflow"><?php esc_html_e('API Testing Workflow', 'tradepress'); ?></option>
                        <option value="api-call-deduplication"><?php esc_html_e('API Call Deduplication Process', 'tradepress'); ?></option>
                        <option value="automation-process"><?php esc_html_e('Automation System Process', 'tradepress'); ?></option>
                        <option value="scoring-pipeline"><?php esc_html_e('Scoring System Pipeline', 'tradepress'); ?></option>
                        <option value="data-freshness"><?php esc_html_e('Data Freshness Framework', 'tradepress'); ?></option>
                        <option value="call-register"><?php esc_html_e('Recent Call Register System', 'tradepress'); ?></option>
                        <option value="symbol-import"><?php esc_html_e('Symbol Import Process', 'tradepress'); ?></option>
                    </optgroup>
                    <optgroup label="Error Handling & Debugging">
                        <option value="error-propagation"><?php esc_html_e('Error Propagation Flow', 'tradepress'); ?></option>
                        <option value="troubleshooting-tree"><?php esc_html_e('Troubleshooting Decision Tree', 'tradepress'); ?></option>
                    </optgroup>
                    <optgroup label="Security & Safety">
                        <option value="api-safety"><?php esc_html_e('API Safety Protocol', 'tradepress'); ?></option>
                        <option value="data-validation"><?php esc_html_e('Data Validation Pipeline', 'tradepress'); ?></option>
                    </optgroup>
                    <optgroup label="Performance & Optimization">
                        <option value="cache-strategy"><?php esc_html_e('Cache Strategy Map', 'tradepress'); ?></option>
                        <option value="database-optimization"><?php esc_html_e('Database Query Optimization', 'tradepress'); ?></option>
                    </optgroup>
                    <optgroup label="User Experience">
                        <option value="admin-navigation"><?php esc_html_e('Admin Interface Navigation', 'tradepress'); ?></option>
                        <option value="setup-wizard"><?php esc_html_e('Setup Wizard Process', 'tradepress'); ?></option>
                    </optgroup>
                    <optgroup label="Development & Maintenance">
                        <option value="code-architecture"><?php esc_html_e('Code Architecture Overview', 'tradepress'); ?></option>
                        <option value="deployment-process"><?php esc_html_e('Deployment & Update Process', 'tradepress'); ?></option>
                    </optgroup>
                    <optgroup label="Business Logic">
                        <option value="trading-strategy"><?php esc_html_e('Trading Strategy Execution', 'tradepress'); ?></option>
                        <option value="api-integration"><?php esc_html_e('API Integration Map', 'tradepress'); ?></option>
                        <option value="trading-flow"><?php esc_html_e('Trading Strategy Flow', 'tradepress'); ?></option>
                    </optgroup>
                </select>
                <button id="fullscreen-btn" class="button"><?php esc_html_e('Fullscreen', 'tradepress'); ?></button>
                <button id="export-btn" class="button"><?php esc_html_e('Export SVG', 'tradepress'); ?></button>
                <button id="ai-analysis-btn" class="button button-primary"><?php esc_html_e('AI Analysis', 'tradepress'); ?></button>
            </div>
            
            <div id="ai-analysis-panel" class="ai-analysis-panel" style="display: none;">
                <div class="analysis-header">
                    <h3><?php esc_html_e('AI System Analysis', 'tradepress'); ?></h3>
                    <button id="close-analysis" class="button-link"><?php esc_html_e('Close', 'tradepress'); ?></button>
                </div>
                <div id="analysis-results" class="analysis-results">
                    <div class="analysis-loading">
                        <span class="spinner is-active"></span>
                        <p><?php esc_html_e('Analyzing system architecture and code implementation...', 'tradepress'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="diagram-info">
                <h3 id="diagram-title"><?php esc_html_e('API Usage Tracking & Fallback System', 'tradepress'); ?></h3>
                <p id="diagram-description"><?php esc_html_e('Intelligent API switching when rate limits are detected, with usage tracking and developer notices.', 'tradepress'); ?></p>
            </div>
        </div>
        ...
        jQuery(document).ready(function($) {
            ...
            const diagrams = {
                ...
                'api-usage-tracking': {
                    title: '<?php esc_html_e('API Usage Tracking & Fallback System', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Intelligent API switching when rate limits are detected, with usage tracking and developer notices.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'api-management-flow': {
                    title: '<?php esc_html_e('API Management Flow with Dual Testing', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Shows the dual testing system (Call Test vs Query Test) with cache checking and rate limit protection.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'bugnet-logging': {
                    title: '<?php esc_html_e('BugNet Logging System Architecture', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Two-tier logging with hook system for modular log file registration and developer mode controls.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'data-flow': {
                    title: '<?php esc_html_e('Data Flow Architecture', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Complete data flow from API to frontend with caching and database storage.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart LR
                ...
                'trading-platform-integration': {
                    title: '<?php esc_html_e('Trading Platform Integration Map', 'tradepress'); ?>',
                    description: '<?php esc_html_e('All supported APIs with connection types, authentication, and data endpoints.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'database-schema': {
                    title: '<?php esc_html_e('Database Schema Relationships', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Core tables and their relationships for symbols, price data, and metadata.', 'tradepress'); ?>',
                    mermaid: `
                        erDiagram
                            SYMBOLS {
                                int ID PK
                ...
                'plugin-dependencies': {
                    title: '<?php esc_html_e('Plugin Module Dependencies', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Core systems and their interdependencies showing module relationships.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'api-call-deduplication': {
                    title: '<?php esc_html_e('API Call Deduplication Process', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Shows how to prevent duplicate API calls between directive handler and directive classes.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'api-testing-workflow': {
                    title: '<?php esc_html_e('API Testing Workflow', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Decision tree for cache checking, API calls, and error handling in testing.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'automation-process': {
                    title: '<?php esc_html_e('Automation System Process', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Cron job scheduling, safety mechanisms, and background processing workflow.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'scoring-pipeline': {
                    title: '<?php esc_html_e('Scoring System Pipeline', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Data input to scoring output with directive execution and strategy validation.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'error-propagation': {
                    title: '<?php esc_html_e('Error Propagation Flow', 'tradepress'); ?>',
                    description: '<?php esc_html_e('How errors flow from WordPress database through BugNet logging to admin notices.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'troubleshooting-tree': {
                    title: '<?php esc_html_e('Troubleshooting Decision Tree', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Step-by-step diagnostic and resolution paths for common issues.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'api-safety': {
                    title: '<?php esc_html_e('API Safety Protocol', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Live vs Paper mode validation with read-only endpoint restrictions and rate limiting.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'data-validation': {
                    title: '<?php esc_html_e('Data Validation Pipeline', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Input sanitization, validation, and storage with security checks at each layer.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'cache-strategy': {
                    title: '<?php esc_html_e('Cache Strategy Map', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Multi-level caching with transients, database, and file cache plus invalidation triggers.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'database-optimization': {
                    title: '<?php esc_html_e('Database Query Optimization', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Query patterns, indexing strategy, and performance bottleneck identification.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'admin-navigation': {
                    title: '<?php esc_html_e('Admin Interface Navigation Map', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Page hierarchy, user flow, and tab relationships in the admin interface.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'setup-wizard': {
                    title: '<?php esc_html_e('Setup Wizard Process Flow', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Initial configuration steps with validation checkpoints and error recovery.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'code-architecture': {
                    title: '<?php esc_html_e('Code Architecture Overview', 'tradepress'); ?>',
                    description: '<?php esc_html_e('MVC pattern implementation with class inheritance and plugin hook system.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'deployment-process': {
                    title: '<?php esc_html_e('Deployment & Update Process', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Version control workflow with database migrations and rollback procedures.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'trading-strategy': {
                    title: '<?php esc_html_e('Trading Strategy Execution', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Signal generation to execution with validation, risk management, and portfolio updates.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'data-freshness': {
                    title: '<?php esc_html_e('Data Freshness Framework with Call Register', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Shows how the Recent Call Register prevents duplicate API calls and integrates with Data Freshness validation.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'call-register': {
                    title: '<?php esc_html_e('Recent Call Register System', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Detailed view of how the Call Register prevents duplicate API calls across multiple features.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'symbol-import': {
                    title: '<?php esc_html_e('Symbol Import Process', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Visualizes the batch symbol import process and database interactions.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'api-integration': {
                    title: '<?php esc_html_e('API Integration Map', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Shows all API providers and their data relationships.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart LR
                            subgraph APIs
                                A[Alpaca API]
                ...
                'trading-flow': {
                    title: '<?php esc_html_e('Trading Strategy Flow', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Shows the complete flow from signal generation to order execution.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
                ...
                'api-data-standardization': {
                    title: '<?php esc_html_e('API Data Standardization Flow', 'tradepress'); ?>',
                    description: '<?php esc_html_e('Eliminates code duplication by standardizing data from different API providers for 100+ directives.', 'tradepress'); ?>',
                    mermaid: `
                        flowchart TD
            ...
            $('#fullscreen-btn').on('click', function() {
                ...
                $(this).text($('.diagram-viewer').hasClass('fullscreen') ? '<?php esc_html_e('Exit Fullscreen', 'tradepress'); ?>' : '<?php esc_html_e('Fullscreen', 'tradepress'); ?>');
            });
            ...
            $(document).on('keydown', function(e) {
                if (e.key === 'Escape' && $('.diagram-viewer').hasClass('fullscreen')) {
                    ...
                    $('#fullscreen-btn').text('<?php esc_html_e('Fullscreen', 'tradepress'); ?>');
                }
            });
            ...
            $('#ai-analysis-btn').on('click', function() {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        nonce: '<?php echo esc_attr( wp_create_nonce('tradepress_ai_analysis') ); // Escaped for safe JS output ?>',
                    ...
                    error: function() {
                        $('#analysis-results').html('<p class="error"><?php esc_html_e('Analysis failed. Please try again.', 'tradepress'); ?></p>');
                    }
                });
            });
            ...
            function displayAnalysisResults(data) {
                ...
                if (data.immediate_issues && data.immediate_issues.length > 0) {
                    ...
                    html += '<h4><?php esc_html_e('Immediate Issues Found', 'tradepress'); ?></h4>';
                ...
                if (data.optimizations && data.optimizations.length > 0) {
                    html += '<div class="analysis-section">';
                    html += '<h4><?php esc_html_e('Optimization Opportunities', 'tradepress'); ?></h4>';
                ...
                if (data.architecture_suggestions && data.architecture_suggestions.length > 0) {
                    html += '<div class="analysis-section">';
                    html += '<h4><?php esc_html_e('Architecture Improvements', 'tradepress'); ?></h4>';
                ...
                if (data.summary) {
                    html += '<div class="analysis-section">';
                    html += '<h4><?php esc_html_e('Analysis Summary', 'tradepress'); ?></h4>';
