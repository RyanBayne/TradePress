							...
							<div class="task-meta">
								...
								<span class="task-priority">
									...
									switch ( intval( $current_task['priority'] ) ) {
										case 1:
											echo esc_html( __( 'High Priority', 'tradepress' ) );
											break;
										case 2:
											echo esc_html( __( 'Medium Priority', 'tradepress' ) );
											break;
										case 3:
											echo esc_html( __( 'Low Priority', 'tradepress' ) );
											break;
										default:
											echo esc_html( __( 'Medium Priority', 'tradepress' ) );
									}
								...
								<span class="task-status">
									...
									switch ( $current_task['status'] ) {
										case 'pending':
											echo esc_html( __( 'Pending', 'tradepress' ) );
											break;
										case 'in-progress':
											echo esc_html( __( 'In Progress', 'tradepress' ) );
											break;
										case 'completed':
											echo esc_html( __( 'Completed', 'tradepress' ) );
											break;
										default:
											echo esc_html( __( 'Pending', 'tradepress' ) );
									}
								...
								<span class="task-github-status">
									...
									<?php
									echo $current_task['is_github_issue']
