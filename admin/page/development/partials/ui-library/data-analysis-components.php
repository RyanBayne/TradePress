...
?>
<div class="tradepress-ui-section tradepress-ui-section--data-analysis">
        ...
        jQuery(document).ready(function(\$) {
            ...
            function animateBars() {
                \$('.media-progress-bar div, .score-fill, .percentage-fill').each(function() {
                    ...
                    \$(this).css('width', '0%').animate({ width: targetWidth }, 1000);
                });
            }
            animateBars();
            ...
            \$('.kpi-item').hover(
                function() { \$(this).addClass('kpi-hover'); },
                function() { \$(this).removeClass('kpi-hover'); }
            );

            \$('.comparison-row').hover(
                function() { \$(this).addClass('row-highlighted'); },
                function() { \$(this).removeClass('row-highlighted'); }
            );
