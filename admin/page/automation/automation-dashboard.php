...
<div class="wrap tradepress-automation-wrap">
    <h1><?php esc_html_e('TradePress Automation', 'tradepress'); /* Use esc_html_e for escaped output per WPCS */ ?></h1>
    
    <div class="dashboard-controls">
        <button class="button button-primary start-all-button">
            <?php esc_html_e('Start All Components', 'tradepress'); ?>
        </button>
        <button class="button stop-all-button">
            <?php esc_html_e('Stop All Components', 'tradepress'); ?>
        </button>
    </div>
    ...
    <div class="components-grid">
        ...
        <div class="component-cards-column">
            ...
            <div class="component-card" id="scoring-algorithm">
                ...
                <div class="component-metrics">
                    <div>
                        <span class="metric-label"><?php esc_html_e('Status', 'tradepress'); ?></span>
                        <span class="metric-value status-value">Active</span>
                    </div>
                    <div>
                        <span class="metric-label"><?php esc_html_e('Symbols', 'tradepress'); ?></span>
                ...
                <div class="component-controls">
                    ...
                    <button class="button stop-button">
                        <?php esc_html_e('Stop', 'tradepress'); ?>
                    </button>
                </div>
            </div>
            ...
            <div class="component-card" id="trading-signals">
                <h4><?php esc_html_e('Trading Signals', 'tradepress'); ?></h4>
                <div class="component-metrics">
                    <div>
                        <span class="metric-label"><?php esc_html_e('Status', 'tradepress'); ?></span>
            ...
            <div class="component-card" id="trading-bot">
                <h4><?php esc_html_e('Trading Bot', 'tradepress'); ?></h4>
                <div class="component-metrics">
                    <div>
                        <span class="metric-label"><?php esc_html_e('Status', 'tradepress'); ?></span>
                        <span class="metric-value status-value">Inactive</span>
                    ...
                    <div>
                        <span class="metric-label"><?php esc_html_e('Open Positions', 'tradepress'); ?></span>
                        <span class="metric-value">0</span>
                    </div>
                </div>
                <div class="component-controls">
        ...
        <div class="component-info-column">
            <h2><?php esc_html_e('Market Intelligence', 'tradepress'); ?></h2>
            
            <!-- Highest Scoring Stock -->
            <div class="info-item">
                <h3><?php esc_html_e('Highest Scoring Stock', 'tradepress'); ?></h3>
                <div class="info-value">AAPL (87.5)</div>
                <div class="info-meta"><?php esc_html_e('Updated 5 minutes ago', 'tradepress'); ?></div>
                <div class="info-details">
                    <p><?php esc_html_e('Strong bullish indicators with positive RSI momentum', 'tradepress'); ?></p>
                </div>
            </div>
            
            <!-- Best Trading Signal -->
            <div class="info-item">
                <h3><?php esc_html_e('Best Trading Signal', 'tradepress'); ?></h3>
                <div class="info-value"><?php esc_html_e('Buy MSFT (Confidence: High)', 'tradepress'); ?></div>
                <div class="info-meta"><?php esc_html_e('Generated 15 minutes ago', 'tradepress'); ?></div>
                <div class="info-details">
                    <p><?php esc_html_e('MACD crossover with increasing volume', 'tradepress'); ?></p>
                </div>
            </div>
            
            <!-- Latest Trade -->
            <div class="info-item">
                <h3><?php esc_html_e('Latest Trade', 'tradepress'); ?></h3>
                <div class="info-value"><?php esc_html_e('No trades executed', 'tradepress'); ?></div>
                <div class="info-meta"><?php esc_html_e('Bot is currently inactive', 'tradepress'); ?></div>
                <div class="info-details">
                    <p><?php esc_html_e('Enable the Trading Bot to execute trades based on signals', 'tradepress'); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="tradepress-automation-container">
        <div class="tradepress-automation-left-column">
            ...
            <div class="tradepress-automation-box" id="tradepress-algorithm-control">
                ...
                <div class="tradepress-algorithm-status">
                    <p><strong><?php esc_html_e('Status:', 'tradepress'); ?></strong> 
                        <span id="tradepress-algorithm-status-text"><?php esc_html_e('Idle', 'tradepress'); ?></span>
                    </p>
                    
                    <p><strong><?php esc_html_e('Runtime:', 'tradepress'); ?></strong> 
                        <span id="tradepress-algorithm-runtime">00:00:00</span>
                    </p>
                    
                    <p><strong><?php esc_html_e('Last Run:', 'tradepress'); ?></strong> 
            ...
            <div class="tradepress-automation-box" id="tradepress-schedule-settings">
                <h2><?php esc_html_e('Schedule Settings', 'tradepress'); ?></h2>
                
                <form id="tradepress-schedule-form">
                    <div class="tradepress-form-group">
                        <label for="tradepress-schedule-type">
                            <?php esc_html_e('Schedule Type:', 'tradepress'); ?>
                        </label>
                        <select id="tradepress-schedule-type" name="schedule_type">
                            <option value="manual"><?php esc_html_e('Manual Only', 'tradepress'); ?></option>
                            <option value="hourly"><?php esc_html_e('Hourly', 'tradepress'); ?></option>
                            <option value="daily"><?php esc_html_e('Daily', 'tradepress'); ?></option>
                            <option value="market_hours"><?php esc_html_e('During Market Hours', 'tradepress'); ?></option>
                            <option value="custom"><?php esc_html_e('Custom Schedule', 'tradepress'); ?></option>
                        </select>
                    </div>
                    ...
                    <div class="tradepress-form-group">
                        <button type="submit" class="button button-primary">
                            <?php esc_html_e('Save Schedule', 'tradepress'); ?>
                        </button>
                    </div>
                </form>
            </div>
            ...
            <div class="tradepress-automation-box" id="tradepress-api-status">
                <h2><?php esc_html_e('API Status', 'tradepress'); ?></h2>
                
                <table class="widefat tradepress-api-status-table">
                    <thead>
                        <tr>
                            <th><?php esc_html_e('API', 'tradepress'); ?></th>
                            <th><?php esc_html_e('Status', 'tradepress'); ?></th>
                            <th><?php esc_html_e('Rate Limit', 'tradepress'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <span class="tradepress-api-rate-limit" data-api="alphavantage">
                                    <?php esc_html_e('80/100 remaining', 'tradepress'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <span class="tradepress-api-rate-limit" data-api="trading212">
                                    <?php esc_html_e('Unlimited', 'tradepress'); ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php esc_html_e('Not Configured', 'tradepress'); ?>
                            </td>
                            <td>
            ...
            <div class="tradepress-automation-diagnostic-panel" id="tradepress-diagnostic-panel">
                <div class="tradepress-diagnostic-header">
                    <h2><?php esc_html_e('Diagnostic Information', 'tradepress'); ?></h2>
                ...
                <div class="tradepress-diagnostic-tabs">
                    <div class="tradepress-diagnostic-tab active" data-tab="logs"><?php esc_html_e('Logs', 'tradepress'); ?></div>
                    <div class="tradepress-diagnostic-tab" data-tab="metrics"><?php esc_html_e('Metrics', 'tradepress'); ?></div>
                    <div class="tradepress-diagnostic-tab" data-tab="api"><?php esc_html_e('API Calls', 'tradepress'); ?></div>
                    <div class="tradepress-diagnostic-tab" data-tab="system"><?php esc_html_e('System', 'tradepress'); ?></div>
                </div>
                ...
                <div class="tradepress-diagnostic-content-container">
                    ...
                    <div class="tradepress-diagnostic-content active" id="tradepress-tab-logs">
                        <div class="tradepress-log-filters">
                            <select id="tradepress-log-level-filter">
                                <option value=""><?php esc_html_e('All Levels', 'tradepress'); ?></option>
                                ...
                                <option value="debug"><?php esc_html_e('Debug (All)', 'tradepress'); ?></option>
                            </select>
                            ...
                            <select id="tradepress-log-category-filter">
                                ...
                                <option value="api"><?php esc_html_e('API', 'tradepress'); ?></option>
                                <option value="trading"><?php esc_html_e('Trading', 'tradepress'); ?></option>
                                <option value="system"><?php esc_html_e('System', 'tradepress'); ?></option>
                            </select>
                            
                            <button id="tradepress-apply-log-filters" class="button">
                                <?php esc_html_e('Apply Filters', 'tradepress'); ?>
                            </button>
                        </div>
                        ...
                        <div class="tradepress-log-entries">
                            ...
                            if (empty($log_entries)) {
                                ...
                                esc_html_e('No log entries found. Log entries will appear here when the algorithm runs.', 'tradepress');
                                echo '</div>';
                            } else {
                    ...
                    <div class="tradepress-diagnostic-content" id="tradepress-tab-metrics" style="display: none;">
                        <h3><?php esc_html_e('Performance Metrics', 'tradepress'); ?></h3>
                        
                        <table class="tradepress-metrics-table">
                            <tr>
                                <th><?php esc_html_e('Metric', 'tradepress'); ?></th>
                                <th><?php esc_html_e('Current', 'tradepress'); ?></th>
                                <th><?php esc_html_e('Average', 'tradepress'); ?></th>
                                <th><?php esc_html_e('Peak', 'tradepress'); ?></th>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('Execution Time', 'tradepress'); ?></td>
                                <td id="metric-exec-time-current">-</td>
                                <td id="metric-exec-time-avg">-</td>
                                <td id="metric-exec-time-peak">-</td>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('Memory Usage', 'tradepress'); ?></td>
                                <td id="metric-memory-current">-</td>
                                <td id="metric-memory-avg">-</td>
                                <td id="metric-memory-peak">-</td>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('Database Queries', 'tradepress'); ?></td>
                                <td id="metric-queries-current">-</td>
                                <td id="metric-queries-avg">-</td>
                                <td id="metric-queries-peak">-</td>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('API Calls', 'tradepress'); ?></td>
                        ...
                        <h3><?php esc_html_e('Algorithm Statistics', 'tradepress'); ?></h3>
                        
                        <table class="tradepress-metrics-table">
                            <tr>
                                <th><?php esc_html_e('Statistic', 'tradepress'); ?></th>
                            ...
                            <tr>
                                <td><?php esc_html_e('Scoring Directives Active', 'tradepress'); ?></td>
                                <td id="stat-directives-active">-</td>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('Highest Symbol Score', 'tradepress'); ?></td>
                                <td id="stat-highest-score">-</td>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('Average Score', 'tradepress'); ?></td>
                    ...
                    <div class="tradepress-diagnostic-content" id="tradepress-tab-api" style="display: none;">
                        <h3><?php esc_html_e('Recent API Calls', 'tradepress'); ?></h3>
                        
                        <div class="tradepress-api-calls-list">
                            <div class="tradepress-empty-api-calls">
                                <?php esc_html_e('API call data will be displayed here when available.', 'tradepress'); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tradepress-diagnostic-content" id="tradepress-tab-system" style="display: none;">
                        <h3><?php esc_html_e('System Information', 'tradepress'); ?></h3>
                        
                        <table class="tradepress-metrics-table">
                            <tr>
                                <th><?php esc_html_e('Setting', 'tradepress'); ?></th>
                                <th><?php esc_html_e('Value', 'tradepress'); ?></th>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('PHP Version', 'tradepress'); ?></td>
                                <td><?php echo PHP_VERSION; ?></td>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('WordPress Version', 'tradepress'); ?></td>
                                <td><?php echo  esc_html( get_bloginfo('version') ); ?></td>
                            </tr>
                            <tr>
                                <td><?php esc_html_e('TradePress Version', 'tradepress'); ?></td>
                                <td><?php echo  esc_html( TRADEPRESS_VERSION ); ?></td>
                            </tr>
                            <tr>
