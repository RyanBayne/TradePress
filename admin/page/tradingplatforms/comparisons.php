	...
	$comparison_data = array(
		'trading212'          => array(
			'real_time_data'        => array(
				'value' => 'Yes',
				'notes' => 'Real-time quotes for funded accounts',
			),
			'historical_data'       => array(
				'value' => 'Yes',
				'notes' => 'Historical price data available',
			),
			'tick_data'             => array(
				'value' => 'No',
				'notes' => 'Not available via API',
			),
			'minute_data'           => array(
				'value' => 'Yes',
				'notes' => 'Minute-level data available',
			),
			'eod_data'              => array(
				'value' => 'Yes',
				'notes' => 'End-of-day data available',
			),
			'fundamental_data'      => array(
				'value' => 'Limited',
				'notes' => 'Basic company info only',
			),
			'options_data'          => array(
				'value' => 'No',
			...
			'forex_data'            => array(
				'value' => 'Yes',
				'notes' => 'FX pairs available',
			),
			'crypto_data'           => array(
				'value' => 'Yes',
				'notes' => 'Crypto CFDs available',
			),
			'rest_api'              => array(
				'value' => 'Yes',
				'notes' => 'RESTful API endpoints',
			),
			'websocket_streaming'   => array(
				'value' => 'No',
				'notes' => 'Not currently available',
			),
			'polling_frequency'     => array(
				'value' => 'Rate limited',
				'notes' => 'Subject to API limits',
			),
			'data_latency'          => array(
				'value' => '~1-2 seconds',
				'notes' => 'Near real-time',
			),
			'free_rate_limit'       => array(
				'value' => 'No free tier',
				'notes' => 'Requires funded account',
			),
			'paid_rate_limit'       => array(
				'value' => '60 requests/min',
				'notes' => 'Per API key',
			),
			'paper_trading'         => array(
				'value' => 'Yes',
				'notes' => 'Demo account available',
			),
			'real_trading'          => array(
				'value' => 'Yes',
				'notes' => 'Live trading supported',
			),
			'market_orders'         => array(
				'value' => 'Yes',
				'notes' => 'Market orders supported',
			),
			'limit_orders'          => array(
				'value' => 'Yes',
				'notes' => 'Limit orders supported',
			),
			'stop_orders'           => array(
				'value' => 'Yes',
				'notes' => 'Stop loss orders',
			),
			'trailing_stops'        => array(
				'value' => 'No',
				'notes' => 'Not available via API',
			),
			'fractional_shares'     => array(
				'value' => 'Yes',
				'notes' => 'Fractional shares supported',
			),
			'order_cancellation'    => array(
				'value' => 'Yes',
				'notes' => 'Pending orders can be cancelled',
			),
			'free_tier'             => array(
				'value' => 'No',
				'notes' => 'Requires funded account',
			),
			'free_tier_limitations' => array(
				'value' => 'N/A',
				'notes' => 'No free tier available',
			),
			'paid_tiers'            => array(
				'value' => 'Free trading',
				'notes' => 'No monthly fees',
			),
			'commission_fees'       => array(
				'value' => 'None',
				'notes' => 'Commission-free trading',
			),
			...
			'api_documentation'     => array(
				'value' => 'Good',
				'notes' => 'Clear documentation with examples',
			),
			'sdk_availability'      => array(
				'value' => 'No',
				'notes' => 'No official SDKs',
			),
			'webhook_support'       => array(
				'value' => 'No',
		...
		'interactive_brokers' => array(
			'real_time_data'        => array(
				'value' => 'Yes (Paid)',
				'notes' => 'Market data subscriptions required',
			),
			'historical_data'       => array(
				'value' => 'Yes',
				'notes' => 'Extensive historical data',
			),
			'tick_data'             => array(
				'value' => 'Yes (Paid)',
				'notes' => 'Level II data available',
			),
			'minute_data'           => array(
				'value' => 'Yes',
				'notes' => 'Minute bars available',
			),
			'eod_data'              => array(
				'value' => 'Yes',
				'notes' => 'End-of-day data included',
			),
			'fundamental_data'      => array(
				'value' => 'Yes',
				'notes' => 'Comprehensive fundamental data',
			),
			'options_data'          => array(
				'value' => 'Yes',
				'notes' => 'Full options chain data',
			),
			'forex_data'            => array(
				'value' => 'Yes',
				'notes' => 'FX pairs and rates',
			),
			'crypto_data'           => array(
				'value' => 'Limited',
				'notes' => 'Select crypto products',
			),
			'rest_api'              => array(
				'value' => 'Yes',
				'notes' => 'Client Portal Web API',
			),
			'websocket_streaming'   => array(
				'value' => 'Yes',
				'notes' => 'TWS API streaming',
			),
			'polling_frequency'     => array(
				'value' => 'Real-time',
				'notes' => 'Streaming data available',
			),
			'data_latency'          => array(
				'value' => '<100ms',
				'notes' => 'Professional-grade latency',
			),
			'free_rate_limit'       => array(
				'value' => 'No free tier',
				'notes' => 'Requires funded account',
			...
			'paid_rate_limit'       => array(
				'value' => 'High',
				'notes' => 'Professional limits',
			),
			'paper_trading'         => array(
				'value' => 'Yes',
				'notes' => 'Full paper trading account',
			),
			'real_trading'          => array(
				'value' => 'Yes',
				'notes' => 'Global markets access',
			),
			'market_orders'         => array(
				'value' => 'Yes',
				'notes' => 'All order types supported',
			),
			'limit_orders'          => array(
				'value' => 'Yes',
			...
			'stop_orders'           => array(
				'value' => 'Yes',
				'notes' => 'Stop and stop-limit orders',
			),
			'trailing_stops'        => array(
				'value' => 'Yes',
				'notes' => 'Trailing stop orders',
			),
			'fractional_shares'     => array(
				'value' => 'Limited',
				'notes' => 'Select US stocks only',
			),
			'order_cancellation'    => array(
				'value' => 'Yes',
				'notes' => 'Full order management',
			),
			'free_tier'             => array(
				'value' => 'No',
				'notes' => 'Requires account minimum',
			),
			'free_tier_limitations' => array(
				'value' => 'N/A',
				'notes' => 'No free tier',
			...
			'commission_fees'       => array(
				'value' => 'Yes',
				'notes' => 'Per-share/contract fees',
			),
			'authentication'        => array(
				'value' => 'OAuth 2.0',
				'notes' => 'Secure OAuth authentication',
			),
			'api_documentation'     => array(
				'value' => 'Excellent',
			...
			'sdk_availability'      => array(
				'value' => 'Yes',
				'notes' => 'Multiple language SDKs',
			),
			'webhook_support'       => array(
				'value' => 'Limited',
				'notes' => 'Event notifications available',
			),
		),
		'etoro'               => array(
			'real_time_data'        => array(
				'value' => 'Yes',
				'notes' => 'Real-time prices for platform users',
			),
			'historical_data'       => array(
				'value' => 'Limited',
				'notes' => 'Basic historical data available',
			),
			'tick_data'             => array(
				'value' => 'No',
				'notes' => 'Not available via API',
			...
			'minute_data'           => array(
				'value' => 'Limited',
				'notes' => 'Basic minute data only',
			),
			'eod_data'              => array(
				'value' => 'Yes',
				'notes' => 'End-of-day pricing available',
			),
			'fundamental_data'      => array(
				'value' => 'Limited',
				'notes' => 'Basic company information',
			),
			'options_data'          => array(
				'value' => 'No',
				'notes' => 'CFDs only, no options',
			),
			'forex_data'            => array(
				'value' => 'Yes',
				'notes' => 'Extensive FX pairs',
			),
			'crypto_data'           => array(
				'value' => 'Yes',
				'notes' => 'Major cryptocurrencies',
			),
			'rest_api'              => array(
				'value' => 'Limited',
				'notes' => 'Restricted API access',
			),
			'websocket_streaming'   => array(
				'value' => 'No',
			...
			'data_latency'          => array(
				'value' => '~5-15 seconds',
				'notes' => 'Consumer-grade latency',
			),
			'free_rate_limit'       => array(
				'value' => 'No public API',
				'notes' => 'API not publicly available',
			),
			'paid_rate_limit'       => array(
				'value' => 'Restricted',
			...
			'paper_trading'         => array(
				'value' => 'Yes',
				'notes' => 'Virtual portfolio available',
			),
			'real_trading'          => array(
				'value' => 'Yes',
				'notes' => 'CFD and stock trading',
			),
			'market_orders'         => array(
				'value' => 'Yes',
				'notes' => 'Market orders supported',
			...
			'fractional_shares'     => array(
				'value' => 'Yes',
				'notes' => 'Fractional investing available',
			),
			'order_cancellation'    => array(
				'value' => 'Yes',
				'notes' => 'Order management available',
			),
			'free_tier'             => array(
				'value' => 'No',
				'notes' => 'Requires account funding',
			),
			'free_tier_limitations' => array(
				'value' => 'N/A',
				'notes' => 'No free API access',
			),
			'paid_tiers'            => array(
				'value' => 'Spread-based',
				'notes' => 'No commission, spread costs',
			),
			'commission_fees'       => array(
				'value' => 'None',
				'notes' => 'Spread-based pricing',
			),
			'authentication'        => array(
				'value' => 'Proprietary',
				'notes' => 'Custom authentication system',
			),
			'api_documentation'     => array(
				'value' => 'Limited',
				'notes' => 'Restricted documentation',
			),
			'sdk_availability'      => array(
				'value' => 'No',
				'notes' => 'No public SDKs',
			),
			'webhook_support'       => array(
				'value' => 'No',
				'notes' => 'Not available',
		...
		'fidelity'            => array(
			'real_time_data'        => array(
				'value' => 'Yes (Paid)',
				'notes' => 'Real-time quotes for account holders',
			),
			'historical_data'       => array(
				'value' => 'Yes',
				'notes' => 'Extensive historical data',
			...
			'fundamental_data'      => array(
				'value' => 'Yes',
				'notes' => 'Company fundamentals available',
			),
			'options_data'          => array(
				'value' => 'Yes',
				'notes' => 'Options chains and data',
			),
			'forex_data'            => array(
				'value' => 'Limited',
				'notes' => 'Limited FX offerings',
			),
			'crypto_data'           => array(
				'value' => 'No',
				'notes' => 'Crypto not supported',
			),
			'rest_api'              => array(
				'value' => 'Yes',
				'notes' => 'RESTful API available',
			),
			'websocket_streaming'   => array(
				'value' => 'Limited',
				'notes' => 'Limited streaming capabilities',
			),
			'polling_frequency'     => array(
				'value' => 'Rate limited',
				'notes' => 'Subject to API limits',
			...
			'data_latency'          => array(
				'value' => '~1-3 seconds',
				'notes' => 'Near real-time for account holders',
			),
			'free_rate_limit'       => array(
				'value' => 'No free tier',
				'notes' => 'Requires Fidelity account',
			),
			'paid_rate_limit'       => array(
				'value' => '120 requests/min',
				'notes' => 'Standard rate limits',
			),
			'paper_trading'         => array(
				'value' => 'Limited',
				'notes' => 'Virtual trading available',
			),
			'real_trading'          => array(
				'value' => 'Yes',
				'notes' => 'Full trading capabilities',
			),
			'market_orders'         => array(
				'value' => 'Yes',
				'notes' => 'Market orders supported',
			...
			'free_tier'             => array(
				'value' => 'No',
				'notes' => 'Requires Fidelity brokerage account',
			),
			'free_tier_limitations' => array(
				'value' => 'N/A',
				'notes' => 'No free tier',
			...
			'paid_tiers'            => array(
				'value' => 'Free trades',
				'notes' => 'No commission on stocks/ETFs',
			),
			'commission_fees'       => array(
				'value' => 'None',
				'notes' => 'Commission-free stock trading',
			),
			'authentication'        => array(
				'value' => 'OAuth 2.0',
				'notes' => 'OAuth authentication required',
			),
			'api_documentation'     => array(
				'value' => 'Good',
				'notes' => 'Comprehensive developer docs',
			),
			'sdk_availability'      => array(
				'value' => 'Limited',
				'notes' => 'Some language support',
			),
			'webhook_support'       => array(
				'value' => 'No',
				'notes' => 'Webhooks not supported',
			),
		),
		'polygon'             => array(
			'real_time_data'        => array(
				'value' => 'Yes (Paid)',
				'notes' => 'Real-time data with paid plans',
			),
			'historical_data'       => array(
				'value' => 'Yes',
				'notes' => 'Extensive historical data',
			...
			'tick_data'             => array(
				'value' => 'Yes (Paid)',
				'notes' => 'Tick-level data available',
			),
			'minute_data'           => array(
				'value' => 'Yes',
				'notes' => 'Minute aggregates available',
			),
			'eod_data'              => array(
				'value' => 'Yes',
				'notes' => 'Daily aggregates included',
			),
			'fundamental_data'      => array(
				'value' => 'Yes',
				'notes' => 'Company financials and details',
			),
			'options_data'          => array(
				'value' => 'Yes (Paid)',
				'notes' => 'Options contracts and chains',
			),
			'forex_data'            => array(
				'value' => 'Yes',
				'notes' => 'FX real-time and historical',
			),
			'crypto_data'           => array(
				'value' => 'Yes',
				'notes' => 'Crypto aggregates and trades',
			),
			'rest_api'              => array(
				'value' => 'Yes',
				'notes' => 'Comprehensive REST API',
			),
			'websocket_streaming'   => array(
				'value' => 'Yes (Paid)',
				'notes' => 'Real-time WebSocket feeds',
			),
			'polling_frequency'     => array(
				'value' => 'High',
				'notes' => 'Based on subscription tier',
			),
			'data_latency'          => array(
				'value' => '<100ms',
				'notes' => 'Low latency for paid tiers',
			),
			'free_rate_limit'       => array(
			...
			'paid_rate_limit'       => array(
				'value' => 'Up to 1000/min',
				'notes' => 'Varies by plan',
			),
			'paper_trading'         => array(
				'value' => 'No',
				'notes' => 'Data-only provider',
			),
			'real_trading'          => array(
				'value' => 'No',
				'notes' => 'Data-only provider',
			...
			'free_tier_limitations' => array(
				'value' => '5 requests/min, 2 years historical',
				'notes' => 'Severe limitations',
			),
			'paid_tiers'            => array(
				'value' => '$99-$399/mo',
				'notes' => 'Professional data plans',
			),
			'commission_fees'       => array(
				'value' => 'N/A',
				'notes' => 'Data subscription model',
			),
			'authentication'        => array(
				'value' => 'API Key',
				'notes' => 'Simple API key authentication',
			),
			'api_documentation'     => array(
				'value' => 'Excellent',
				'notes' => 'Comprehensive and well-organized',
			),
			'sdk_availability'      => array(
				'value' => 'Yes',
				'notes' => 'Multiple language SDKs',
			...
			'webhook_support'       => array(
				'value' => 'Yes',
				'notes' => 'WebSocket streaming available',
			),
		),
		'tradier'             => array(
			'real_time_data'        => array(
				'value' => 'Yes',
				'notes' => 'Real-time quotes included',
			),
			'historical_data'       => array(
				'value' => 'Yes',
				'notes' => 'Historical price data available',
			...
			'tick_data'             => array(
				'value' => 'No',
				'notes' => 'Tick data not available',
			),
			'minute_data'           => array(
				'value' => 'Yes',
				'notes' => 'Intraday minute data',
			),
			'eod_data'              => array(
				'value' => 'Yes',
				'notes' => 'End-of-day data included',
			...
			'options_data'          => array(
				'value' => 'Yes',
				'notes' => 'Full options chains and data',
			),
			'forex_data'            => array(
				'value' => 'No',
				'notes' => 'Forex not supported',
			),
			'crypto_data'           => array(
				'value' => 'No',
				'notes' => 'Crypto not supported',
			...
			'websocket_streaming'   => array(
				'value' => 'Yes',
				'notes' => 'Real-time streaming available',
			),
			'polling_frequency'     => array(
				'value' => 'High',
				'notes' => 'Professional rate limits',
			),
			'data_latency'          => array(
				'value' => '~200ms',
				'notes' => 'Near real-time data',
			),
			'free_rate_limit'       => array(
				'value' => 'No free tier',
				'notes' => 'Requires brokerage account',
			),
			'paid_rate_limit'       => array(
				'value' => '120 requests/min',
				'notes' => 'Standard API limits',
			),
			'paper_trading'         => array(
				'value' => 'Yes',
				'notes' => 'Sandbox environment available',
			),
			'real_trading'          => array(
				'value' => 'Yes',
				'notes' => 'Full brokerage capabilities',
			),
			'market_orders'         => array(
				'value' => 'Yes',
				'notes' => 'Market orders supported',
			...
			'free_tier'             => array(
				'value' => 'No',
				'notes' => 'Requires funded brokerage account',
			),
			'free_tier_limitations' => array(
				'value' => 'N/A',
				'notes' => 'No free tier',
			...
			'paid_tiers'            => array(
				'value' => '$0.35/contract',
				'notes' => 'Per-contract options pricing',
			),
			'commission_fees'       => array(
				'value' => 'Yes',
				'notes' => 'Options: $0.35/contract, Stocks: varies',
			),
			'authentication'        => array(
				'value' => 'OAuth 2.0',
				'notes' => 'OAuth authentication required',
		...
		'twelvedata'          => array(
			...
			'minute_data'           => array(
				'value' => 'Yes',
				'notes' => 'Minute-level intraday data',
			),
			'eod_data'              => array(
				'value' => 'Yes',
				'notes' => 'End-of-day data included',
			...
			'fundamental_data'      => array(
				'value' => 'Yes',
				'notes' => 'Company profiles and financials',
			),
			'options_data'          => array(
				'value' => 'No',
				'notes' => 'Options data not available',
			),
			'forex_data'            => array(
				'value' => 'Yes',
				'notes' => 'Comprehensive FX pairs',
			),
			'crypto_data'           => array(
				'value' => 'Yes',
				'notes' => 'Major cryptocurrencies',
			...
			'polling_frequency'     => array(
				'value' => 'High',
				'notes' => 'Based on subscription plan',
			),
			'data_latency'          => array(
				'value' => '~1-5 seconds',
				'notes' => 'Near real-time for paid plans',
			),
			'free_rate_limit'       => array(
				'value' => '8 requests/min',
				'notes' => 'Free tier available',
			),
			'paid_rate_limit'       => array(
				'value' => 'Up to 5000/min',
				'notes' => 'Varies by plan',
			),
			'paper_trading'         => array(
				'value' => 'No',
			...
			'free_tier'             => array(
				'value' => 'Yes',
				'notes' => 'Basic free tier available',
			),
			'free_tier_limitations' => array(
				'value' => '8 requests/min, delayed data',
				'notes' => 'Limited functionality',
			),
			'paid_tiers'            => array(
				'value' => '$8-$149/mo',
				'notes' => 'Multiple subscription tiers',
			),
			'commission_fees'       => array(
				'value' => 'N/A',
				'notes' => 'Subscription-based pricing',
			),
			'authentication'        => array(
				'value' => 'API Key',
				'notes' => 'Simple API key authentication',
			...
			'api_documentation'     => array(
				'value' => 'Excellent',
				'notes' => 'Clear and comprehensive docs',
			),
			'sdk_availability'      => array(
				'value' => 'Yes',
				'notes' => 'Multiple language SDKs',
		...
		'iexcloud'            => array(
			...
			'fundamental_data'      => array(
				'value' => 'Yes',
				'notes' => 'Company stats and financials',
			),
			'options_data'          => array(
				'value' => 'Limited',
				'notes' => 'Basic options data only',
			),
			'forex_data'            => array(
				'value' => 'Yes',
				'notes' => 'Major currency pairs',
			),
			'crypto_data'           => array(
				'value' => 'Yes',
				'notes' => 'Major cryptocurrencies',
			...
			'websocket_streaming'   => array(
				'value' => 'Yes (Paid)',
				'notes' => 'SSE streaming available',
			),
			'polling_frequency'     => array(
				'value' => 'High',
				'notes' => 'Based on subscription',
			),
			'data_latency'          => array(
				'value' => '~15ms',
				'notes' => 'Very low latency',
			),
			'free_rate_limit'       => array(
				'value' => '100 requests/day',
				'notes' => 'Very limited free tier',
			),
			'paid_rate_limit'       => array(
				'value' => 'Up to 1M/month',
				'notes' => 'Message-based pricing',
			),
			'paper_trading'         => array(
				'value' => 'No',
				'notes' => 'Data-only provider',
			...
			'free_tier_limitations' => array(
				'value' => '100 requests/day, delayed data',
				'notes' => 'Extremely limited',
			),
			'paid_tiers'            => array(
				'value' => '$0.0005-$0.05/message',
		...
		'alphavantage'        => array(
			'real_time_data'        => array(
				'value' => 'Yes (Paid)',
				'notes' => 'Real-time with premium plans',
			),
			'historical_data'       => array(
				'value' => 'Yes',
				'notes' => 'Extensive historical data',
			...
			'eod_data'              => array(
				'value' => 'Yes',
				'notes' => 'Daily time series data',
			),
			'fundamental_data'      => array(
				'value' => 'Yes',
				'notes' => 'Company overview and financials',
			),
			'options_data'          => array(
				'value' => 'No',
				'notes' => 'Options data not available',
			...
			'rest_api'              => array(
				'value' => 'Yes',
				'notes' => 'Simple REST API',
			),
			'websocket_streaming'   => array(
				'value' => 'No',
				'notes' => 'No streaming available',
			),
			'polling_frequency'     => array(
				'value' => 'Rate limited',
				'notes' => 'Based on subscription',
			...
			'data_latency'          => array(
				'value' => '~15 minutes',
				'notes' => 'Delayed data on free tier',
			),
			'free_rate_limit'       => array(
				'value' => '25 requests/day',
				'notes' => 'Very limited free tier',
			),
			'paid_rate_limit'       => array(
				'value' => '75-1200/min',
			...
			'free_tier_limitations' => array(
				'value' => '25 requests/day, 15min delay',
				'notes' => 'Severe limitations',
			),
			'paid_tiers'            => array(
				'value' => '$25-$1200/mo',
			...
			'sdk_availability'      => array(
				'value' => 'Limited',
				'notes' => 'Community SDKs available',
			),
			'webhook_support'       => array(
				'value' => 'No',
				'notes' => 'No webhook support',
			),
			'technical_indicators'  => array(
				'value' => 'Yes',
				'notes' => 'Comprehensive technical indicators: RSI, MACD, CCI, ADX, Bollinger Bands, EMA, SMA, etc.',
			),
			'aggregate_indicators'  => array(
				'value' => 'No',
				'notes' => 'Individual indicators only, no aggregate analysis',
			),
			'candlestick_patterns'  => array(
				'value' => 'No',
				'notes' => 'No pattern recognition',
			),
			'support_resistance'    => array(
				'value' => 'No',
				'notes' => 'No support/resistance analysis',
			),
			'news_sentiment'        => array(
				'value' => 'Yes',
				'notes' => 'News sentiment data available',
			),
		),
		'alltick'             => array(
			'real_time_data'        => array(
				'value' => 'Yes',
				'notes' => 'Real-time tick data available',
			),
			'historical_data'       => array(
				'value' => 'Yes',
				'notes' => 'Historical tick and bar data',
			),
			'tick_data'             => array(
				'value' => 'Yes',
				'notes' => 'Tick-by-tick data available',
			),
			'minute_data'           => array(
				'value' => 'Yes',
				'notes' => 'Minute bar data',
			),
			'eod_data'              => array(
				'value' => 'Yes',
				'notes' => 'Daily bar data',
			),
			'fundamental_data'      => array(
				'value' => 'Limited',
				'notes' => 'Basic instrument info only',
			),
			'options_data'          => array(
				'value' => 'Yes',
				'notes' => 'Options tick data',
			),
			'forex_data'            => array(
				'value' => 'Yes',
				'notes' => 'FX tick data',
			...
			'crypto_data'           => array(
				'value' => 'Yes',
				'notes' => 'Crypto tick data',
			),
			'rest_api'              => array(
				'value' => 'Yes',
				'notes' => 'REST API for queries',
			),
			'websocket_streaming'   => array(
				'value' => 'Yes',
				'notes' => 'Real-time WebSocket feeds',
			...
			'paid_tiers'            => array(
				...
				'notes' => 'Enterprise pricing model',
			),
			'commission_fees'       => array(
				'value' => 'N/A',
			...
			'api_documentation'     => array(
				'value' => 'Limited',
				'notes' => 'Basic documentation available',
			),
			'sdk_availability'      => array(
				'value' => 'Limited',
				'notes' => 'Some language support',
			...
			'webhook_support'       => array(
				'value' => 'Yes',
				'notes' => 'WebSocket streaming',
			),
		),
		'eodhd'               => array(
			'real_time_data'        => array(
				'value' => 'Yes (Paid)',
				'notes' => 'Real-time data with premium plans',
			),
			'historical_data'       => array(
				'value' => 'Yes',
				'notes' => 'Extensive historical data (their specialty)',
			),
			'tick_data'             => array(
				'value' => 'No',
				'notes' => 'Tick data not available',
			...
			'eod_data'              => array(
				'value' => 'Yes',
				'notes' => 'End-of-day data (core offering)',
			),
			'fundamental_data'      => array(
				'value' => 'Yes',
				'notes' => 'Comprehensive fundamentals',
			),
			'options_data'          => array(
				'value' => 'Yes',
				'notes' => 'Options historical data',
			),
			'forex_data'            => array(
				'value' => 'Yes',
				'notes' => 'FX historical data',
			),
			'crypto_data'           => array(
				'value' => 'Yes',
				'notes' => 'Crypto historical data',
			),
			'rest_api'              => array(
				'value' => 'Yes',
				'notes' => 'Comprehensive REST API',
			...
			'free_rate_limit'       => array(
				'value' => '20 requests/day',
				'notes' => 'Very limited free tier',
			),
			'paid_rate_limit'       => array(
				'value' => '100K-1M/day',
				'notes' => 'High daily limits',
			),
			'paper_trading'         => array(
				'value' => 'No',
				'notes' => 'Data-only provider',
			...
			'free_tier_limitations' => array(
				'value' => '20 requests/day, delayed data',
				'notes' => 'Very restrictive',
			),
			'paid_tiers'            => array(
				'value' => '$19.99-$79.99/mo',
				'notes' => 'Affordable pricing tiers',
			),
			'commission_fees'       => array(
				'value' => 'N/A',
				'notes' => 'Subscription-based pricing',
			...
			'authentication'        => array(
				'value' => 'API Key',
				'notes' => 'Simple token authentication',
			),
			'api_documentation'     => array(
				'value' => 'Excellent',
				'notes' => 'Comprehensive documentation',
		...
		'finnhub'             => array(
			...
			'minute_data'           => array(
				'value' => 'Yes',
				'notes' => 'Minute resolution data',
			),
			'eod_data'              => array(
				'value' => 'Yes',
				'notes' => 'Daily candles available',
			),
			'fundamental_data'      => array(
				'value' => 'Yes',
				'notes' => 'Company profiles, metrics, earnings, news',
			),
			'options_data'          => array(
				'value' => 'No',
				'notes' => 'Options data not available',
			...
			'forex_data'            => array(
				'value' => 'Yes',
				'notes' => 'FX rates and data',
			),
			'crypto_data'           => array(
				'value' => 'Yes',
				'notes' => 'Crypto exchanges data',
			),
			'rest_api'              => array(
				'value' => 'Yes',
				'notes' => 'Comprehensive REST API',
			...
			'paid_rate_limit'       => array(
				'value' => '300-600/min',
				'notes' => 'Higher limits with paid plans',
			),
			'paper_trading'         => array(
				'value' => 'No',
				'notes' => 'Data-only provider',
			...
			'free_tier_limitations' => array(
				'value' => '60 requests/min, delayed data',
				'notes' => 'Good free access',
			),
			'paid_tiers'            => array(
				'value' => '$7.99-$99.99/mo',
				'notes' => 'Affordable pricing',
			),
			'commission_fees'       => array(
				'value' => 'N/A',
				'notes' => 'Subscription-based pricing',
			...
			'technical_indicators'  => array(
				'value' => 'No',
				'notes' => 'No built-in technical indicators',
			),
			'aggregate_indicators'  => array(
				'value' => 'Yes',
				'notes' => 'Aggregate technical analysis with buy/sell signals, includes ADX',
			),
			'candlestick_patterns'  => array(
				'value' => 'Yes',
				'notes' => 'Candlestick pattern detection and recognition',
			),
			'support_resistance'    => array(
				'value' => 'Yes',
				'notes' => 'Support and resistance level identification',
			),
			'news_sentiment'        => array(
				'value' => 'Yes',
				'notes' => 'News sentiment analysis and buzz metrics',
			),
		),
		'fmp'                 => array(
			'real_time_data'        => array(
				'value' => 'Yes (Paid)',
				'notes' => 'Real-time quotes with paid plans',
			),
			'historical_data'       => array(
				'value' => 'Yes',
				'notes' => 'Extensive historical data',
			...
			'eod_data'              => array(
				'value' => 'Yes',
				'notes' => 'Daily historical data',
			),
			'fundamental_data'      => array(
				'value' => 'Yes',
				'notes' => 'Comprehensive fundamentals (specialty)',
			),
			'options_data'          => array(
				'value' => 'Limited',
				'notes' => 'Basic options data',
			),
			'forex_data'            => array(
				'value' => 'Yes',
				'notes' => 'FX rates available',
			),
			'crypto_data'           => array(
				'value' => 'Yes',
				'notes' => 'Crypto prices',
			...
			'data_latency'          => array(
				'value' => '~15 minutes',
				'notes' => 'Delayed on free tier',
			),
			'free_rate_limit'       => array(
				'value' => '250 requests/day',
				'notes' => 'Decent free tier',
			),
			'paid_rate_limit'       => array(
				'value' => '300-10K/day',
				'notes' => 'Daily limits vary by plan',
			),
			'paper_trading'         => array(
				'value' => 'No',
				'notes' => 'Data-only provider',
			...
			'free_tier'             => array(
				'value' => 'Yes',
				'notes' => 'Good free tier',
			),
			'free_tier_limitations' => array(
				'value' => '250 requests/day, delayed data',
				'notes' => 'Reasonable limits',
			),
			'paid_tiers'            => array(
				'value' => '$14-$399/mo',
				'notes' => 'Multiple pricing tiers',
			),
			'commission_fees'       => array(
				'value' => 'N/A',
				'notes' => 'Subscription-based pricing',
			...
			'api_documentation'     => array(
				'value' => 'Excellent',
				'notes' => 'Comprehensive with examples',
			),
			'sdk_availability'      => array(
				'value' => 'Yes',
				'notes' => 'Multiple language SDKs',
		...
		'intrinio'            => array(
			...
			'minute_data'           => array(
				'value' => 'Yes',
				'notes' => 'Intraday minute bars',
			),
			'eod_data'              => array(
				'value' => 'Yes',
				'notes' => 'Daily price data',
			),
			'fundamental_data'      => array(
				'value' => 'Yes',
				'notes' => 'Comprehensive fundamentals',
			...
			'options_data'          => array(
				'value' => 'Yes',
				'notes' => 'Options prices and Greeks',
			),
			'forex_data'            => array(
				'value' => 'Limited',
				'notes' => 'Basic FX data',
			...
			'rest_api'              => array(
				'value' => 'Yes',
				'notes' => 'Professional REST API',
			),
			'websocket_streaming'   => array(
				'value' => 'Yes (Paid)',
				'notes' => 'Real-time streaming feeds',
			),
			'polling_frequency'     => array(
				'value' => 'High',
				'notes' => 'Professional limits',
			...
			'free_tier_limitations' => array(
				'value' => 'N/A',
				'notes' => 'Enterprise pricing only',
			),
			'paid_tiers'            => array(
				'value' => 'Custom pricing',
				'notes' => 'Enterprise sales model',
			),
			'commission_fees'       => array(
				'value' => 'N/A',
				'notes' => 'Subscription-based',
			...
			'authentication'        => array(
				'value' => 'API Key',
				'notes' => 'Secure API authentication',
			),
			'api_documentation'     => array(
				'value' => 'Excellent',
				'notes' => 'Professional documentation',
			),
			'sdk_availability'      => array(
				'value' => 'Yes',
				'notes' => 'Multiple language SDKs',
		...
		'marketstack'         => array(
			...
			'free_rate_limit'       => array(
				'value' => '1000 requests/month',
				'notes' => 'Limited free tier',
			),
			'paid_rate_limit'       => array(
				'value' => '10K-1M/month',
				'notes' => 'Monthly limits',
			),
			'paper_trading'         => array(
				'value' => 'No',
				'notes' => 'Data-only provider',
			...
			'free_tier'             => array(
				'value' => 'Yes',
				'notes' => 'Basic free tier',
			),
			'free_tier_limitations' => array(
				'value' => '1000 requests/month, delayed data',
				'notes' => 'Very limited',
			),
			'paid_tiers'            => array(
				'value' => '$9.99-$99.99/mo',
		...
		'tradingview'         => array(
			'real_time_data'        => array(
				'value' => 'Yes (Paid)',
				'notes' => 'Real-time data with premium subscriptions',
			),
			'historical_data'       => array(
				'value' => 'Yes',
				'notes' => 'Extensive historical data',
			...
			'tick_data'             => array(
				'value' => 'No',
				'notes' => 'Tick data not available via API',
			),
			'minute_data'           => array(
				'value' => 'Yes',
				'notes' => 'Minute-level chart data',
			),
			'eod_data'              => array(
				'value' => 'Yes',
				'notes' => 'Daily chart data',
			),
			'fundamental_data'      => array(
				'value' => 'Limited',
				'notes' => 'Basic company info',
			),
			'options_data'          => array(
				'value' => 'Limited',
				'notes' => 'Basic options data',
			...
			'forex_data'            => array(
				'value' => 'Yes',
				'notes' => 'Comprehensive FX data',
			),
			'crypto_data'           => array(
				'value' => 'Yes',
				'notes' => 'Major crypto exchanges',
			),
			'rest_api'              => array(
				'value' => 'Limited',
				'notes' => 'Charting Library API only',
			),
			'websocket_streaming'   => array(
				'value' => 'Yes (Paid)',
				'notes' => 'Real-time feeds for partners',
			),
			'polling_frequency'     => array(
				'value' => 'Limited',
				'notes' => 'Restricted API access',
			...
			'data_latency'          => array(
				'value' => '~1 second',
				'notes' => 'Near real-time for premium',
			),
			'free_rate_limit'       => array(
				'value' => 'No public API',
				'notes' => 'No free public API',
			),
			'paid_rate_limit'       => array(
				'value' => 'Partner only',
			...
			'paper_trading'         => array(
				'value' => 'Yes',
				'notes' => 'Paper trading available',
			),
			'real_trading'          => array(
				'value' => 'Yes (Partners)',
				'notes' => 'Via broker integrations',
			),
			'market_orders'         => array(
				'value' => 'Yes (Partners)',
				'notes' => 'Through integrated brokers',
			),
			'limit_orders'          => array(
				'value' => 'Yes (Partners)',
				'notes' => 'Through integrated brokers',
			...
			'fractional_shares'     => array(
				'value' => 'Depends on broker',
				'notes' => 'Varies by integrated broker',
			),
			'order_cancellation'    => array(
				'value' => 'Yes (Partners)',
				'notes' => 'Through integrated brokers',
			...
			'free_tier_limitations' => array(
				'value' => 'N/A',
				'notes' => 'Partnership required',
			),
			'paid_tiers'            => array(
				'value' => 'Custom partnership',
				'notes' => 'Enterprise partnership model',
			),
			'commission_fees'       => array(
				'value' => 'Depends on broker',
				'notes' => 'Varies by integrated broker',
			...
			'authentication'        => array(
				'value' => 'OAuth 2.0',
				'notes' => 'Partner authentication',
			),
			'api_documentation'     => array(
				'value' => 'Limited',
				'notes' => 'Partner-only documentation',
			),
			'sdk_availability'      => array(
				'value' => 'Yes',
				'notes' => 'Charting Library SDK',
			),
			'webhook_support'       => array(
				'value' => 'Yes (Partners)',
				'notes' => 'For integrated brokers',
			),
		),
		'tradingapi'          => array(
			'real_time_data'        => array(
			...
			'minute_data'           => array(
				'value' => 'Yes',
				'notes' => 'Minute-level data',
			),
			'eod_data'              => array(
				'value' => 'Yes',
				'notes' => 'End-of-day data',
			),
			'fundamental_data'      => array(
				'value' => 'Limited',
				'notes' => 'Basic company information',
			...
			'websocket_streaming'   => array(
				'value' => 'Limited',
				'notes' => 'Basic streaming available',
			),
			'polling_frequency'     => array(
				'value' => 'Rate limited',
				'notes' => 'Standard rate limits',
		...
		'webull'              => array(
			...
			'fundamental_data'      => array(
				'value' => 'Yes',
				'notes' => 'Company fundamentals and news',
			),
			'options_data'          => array(
				'value' => 'Yes',
				'notes' => 'Options chains and data',
			...
			'crypto_data'           => array(
				'value' => 'Yes',
				'notes' => 'Crypto trading data',
			),
			'rest_api'              => array(
				'value' => 'Limited',
				'notes' => 'Unofficial/reverse-engineered APIs',
			),
			'websocket_streaming'   => array(
				'value' => 'Limited',
				'notes' => 'Unofficial streaming',
			),
			'polling_frequency'     => array(
				'value' => 'Limited',
				'notes' => 'Unofficial API limits',
			),
			'data_latency'          => array(
				'value' => '~1-3 seconds',
				'notes' => 'Near real-time',
			...
			'free_rate_limit'       => array(
				'value' => 'No official API',
				'notes' => 'Unofficial APIs only',
			),
			'paid_rate_limit'       => array(
				'value' => 'No official API',
				'notes' => 'No official paid API',
			),
			'paper_trading'         => array(
				'value' => 'Yes',
				'notes' => 'Paper trading account available',
			),
			'real_trading'          => array(
				'value' => 'Yes',
				'notes' => 'Live trading (app/web only)',
			),
			'market_orders'         => array(
				'value' => 'Yes',
				'notes' => 'Market orders supported',
			...
			'free_tier'             => array(
				'value' => 'No official API',
				'notes' => 'No official API available',
			),
			'free_tier_limitations' => array(
				'value' => 'N/A',
				'notes' => 'No official API',
			),
			'paid_tiers'            => array(
				'value' => 'Commission-free',
				'notes' => 'No API fees (no official API)',
			),
			'commission_fees'       => array(
				'value' => 'None',
				'notes' => 'Commission-free trading',
			...
			'authentication'        => array(
				'value' => 'Unofficial',
				'notes' => 'Reverse-engineered auth',
			),
			'api_documentation'     => array(
				'value' => 'None',
				'notes' => 'No official documentation',
			),
			'sdk_availability'      => array(
				'value' => 'No',
				'notes' => 'No official SDKs',
		...
		'alpaca'              => array(
			'real_time_data'        => array(
				'value' => 'Yes (Paid)',
				'notes' => 'Free with funded account',
			),
			'historical_data'       => array(
				'value' => 'Yes',
				'notes' => 'Free tier available',
			...
			'tick_data'             => array(
				'value' => 'Yes (Paid)',
				'notes' => 'Via Data API subscription',
			),
			'minute_data'           => array(
				'value' => 'Yes',
				'notes' => 'Free tier available',
			...
			'options_data'          => array(
				'value' => 'Yes (Paid)',
				'notes' => 'Via Market Data subscription',
			),
			'forex_data'            => array(
				'value' => 'No',
				'notes' => '',
			...
			'free_rate_limit'       => array(
				'value' => '200 requests/min',
				'notes' => 'For market data',
			),
			'paid_rate_limit'       => array(
				'value' => 'Higher',
				'notes' => 'Varies by subscription',
			),
			'paper_trading'         => array(
				'value' => 'Yes',
				'notes' => 'Full-featured',
			...
			'free_tier_limitations' => array(
				'value' => 'Delayed data, rate limits',
				'notes' => '',
			),
			'paid_tiers'            => array(
				'value' => '$9-$99/mo',
				'notes' => 'Based on plan level',
			),
			'commission_fees'       => array(
				'value' => 'None',
				'notes' => 'Commission-free trading',
						...
						<tbody>
							<?php foreach ( $category['fields'] as $field_id => $field_name ) : ?>
								<tr>
									...
									<?php
									foreach ( $providers as $provider_id => $provider ) :
										$field_data = isset( $comparison_data[ $provider_id ][ $field_id ] ) ? $comparison_data[ $provider_id ][ $field_id ] : array(
											'value' => 'N/A',
											'notes' => '',
										);
				...
				<table class="widefat comparison-table">
					...
					<tbody>
						...
						foreach ( $ordered_directives as $directive_key ) :
							if ( ! isset( $capability_matrix[ $directive_key ] ) ) {
								continue;
							}
							...
							<tr class="<?php echo $is_alpha ? 'alpha-directive' : ''; ?>">
								...
								<?php
								foreach ( $providers as $provider_id => $provider ) :
									$capability = isset( $directive['providers'][ $provider_id ] ) ? $directive['providers'][ $provider_id ] : array(
										'supported' => false,
										'status'    => 'unknown',
										'notes'     => 'No data',
									);
