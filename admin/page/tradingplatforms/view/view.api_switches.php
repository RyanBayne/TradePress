                        ...
                        <td>
                            <fieldset>
                                ...
                                <label>
                                    ...
                                    <?php printf(esc_html__('Display %s Tab', 'tradepress'), $display_name); ?> // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                </label>
                                <br>
                                <label>
                                    ...
                                    <?php /* translators: %s: string value */ ?>
                                    <?php printf(esc_html__('Log %s API Activity', 'tradepress'), $display_name); ?> // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                </label>
                            </fieldset>
                        </td>
                    </tr>
