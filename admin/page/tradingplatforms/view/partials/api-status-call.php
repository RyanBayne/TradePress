							...
							if ( class_exists( 'TradePress_AJAX' ) ) {
								...
								<?php else : ?>
									<div class="api-info-message">
										...
										<p><?php printf( esc_html__( 'No recent API calls for %s have been cached. Make an API call with testing mode enabled to see results here.', 'tradepress' ), esc_html( $api_id ) ); ?></p>
									</div>
									<?php
								endif;
							} else {
