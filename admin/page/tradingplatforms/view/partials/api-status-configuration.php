<div class="api-status-column">
                    <div class="status-box">
                        ...
                        <div class="test-credentials-buttons">
                            <button type="button" class="button test-api-connection" data-api="<?php echo esc_attr($api_id); ?>" data-nonce="<?php echo wp_create_nonce('test-api-connection'); ?>"> // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                <span class="dashicons dashicons-yes"></span> 
                        ...
                        <div class="api-credentials-container">
                            ...
                            <div class="api-credentials-column">
                                ...
                                <div class="test-credentials-buttons">
                                    <button type="button" class="button test-api-credentials" data-api="<?php echo esc_attr($api_id); ?>" data-mode="real" data-nonce="<?php echo wp_create_nonce('test-api-credentials'); ?>"> // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                        <span class="dashicons dashicons-yes"></span> 
                            ...
                            <div class="api-credentials-column">
                                ...
                                <div class="test-credentials-buttons">
                                    <button type="button" class="button test-api-credentials" data-api="<?php echo esc_attr($api_id); ?>" data-mode="paper" data-nonce="<?php echo wp_create_nonce('test-api-credentials'); ?>"> // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                        <span class="dashicons dashicons-yes"></span> 
