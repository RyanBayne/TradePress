<?php
/**
 * TradePress - Symbols Page
 *
 * Handles the display and functionality of the Symbols admin page
 *
 * @author   Ryan Bayne
 * @category Admin
...
if ( ! class_exists( 'TradePress_Admin_Symbols_Page' ) ) :

	/**
	 * TradePress_Admin_Symbols_Page Class
	 */
	class TradePress_Admin_Symbols_Page {
		...
		public function enqueue_assets( $hook ) {
			...
			if ( $hook !== 'tradepress_page_tradepress_symbols' ) {
				return;
			}

			// Enqueue symbols specific script
			wp_enqueue_script(
				'tradepress-symbols',
				TRADEPRESS_PLUGIN_URL . 'js/admin-symbols.js',
				array( 'jquery' ),
				TRADEPRESS_VERSION,
				true
			);
			...
			wp_localize_script(
				...
				array(
					...
					'nonce'    => wp_create_nonce( 'tradepress_symbols_nonce' ),
				)
			);
		}
		...
		public static function get_tabs() {
			$tabs = array(
				...
				'comparisons'       => array(
					'name'     => __( 'Comparisons', 'tradepress' ),
		...
		public static function alltick_tab() {
				...
				switch ( $action ) {
					...
					case 'update_settings':
						...
						if ( isset( $_POST['alltick_update_frequency'] ) ) {
							update_option(
								'tradepress_alltick_update_frequency',
			...
			include __DIR__ . '/view/view.alltick.php';
		}
		...
		public static function alpaca_tab() {
			include __DIR__ . '/view/view.alpaca.php';
		}
		...
		public static function iexcloud_tab() {
			include __DIR__ . '/view/view.iexcloud.php';
		}
		...
		public static function polygon_tab() {
			include __DIR__ . '/view/view.polygon.php';
		}
		...
		public static function tradier_tab() {
			include __DIR__ . '/view/view.tradier.php';
		}
		...
		public static function finnhub_tab() {
			include __DIR__ . '/view/view.finnhub.php';
		}
		...
		public static function twitter_tab() {
			include __DIR__ . '/view/view.twitter.php';
		}
		...
		public static function stocktwits_tab() {
			include __DIR__ . '/view/view.stocktwits.php';
		}
		...
		public static function twelvedata_tab() {
			include __DIR__ . '/view/view.twelvedata.php';
		}
		...
		public static function ibkr_tab() {
			include __DIR__ . '/view/view.ibkr.php';
		}
		...
		public static function tradingview_tab() {
			include __DIR__ . '/view/view.tradingview.php';
		}
		...
		public static function marketstack_tab() {
			include __DIR__ . '/view/view.marketstack.php';
		}
		...
		public static function eodhistoricaldata_tab() {
			include __DIR__ . '/view/view.eodhistoricaldata.php';
		}
		...
		public static function yahoofinance_tab() {
			include __DIR__ . '/view/view.yahoofinance.php';
		}
		...
		public static function tiingo_tab() {
			include __DIR__ . '/view/view.tiingo.php';
		}
		...
		public static function alphavantage_tab() {
			include __DIR__ . '/view/view.alphavantage.php';
		}
		...
		public static function quandl_tab() {
			include __DIR__ . '/view/view.quandl.php';
		}
		...
		public static function fred_tab() {
			include __DIR__ . '/view/view.fred.php';
		}
		...
		public static function gemini_tab() {
			include __DIR__ . '/view/view.gemini.php';
		}
		...
		public static function webull_tab() {
			include __DIR__ . '/view/view.webull.php';
		}
		...
		public static function trading212_tab() {
			include __DIR__ . '/view/view.trading212.php';
		}
		...
		public static function overview_tab() {
			include __DIR__ . '/view/view.overview.php';
		}
		...
		public static function settings_tab() {
			...
			if ( isset( $_POST['save_api_provider'] ) && isset( $_POST['_wpnonce'] ) && wp_verify_nonce( $_POST['_wpnonce'], 'tradepress-api-settings-provider' ) ) {
				...
				if ( $service == 'twitter' && isset( $_POST[ 'api_' . $service . '_token_secret' ] ) ) {
					update_option(
						'TradePress_allapi_' . $service . '_default_access_token_secret',
				...
				do_action(
					'TradePress_allapi_application_update_' . $service,
					$service,
			...
			include __DIR__ . '/view/sp-settings.php';
		}
		...
		public static function api_switches_tab() {
			...
			include __DIR__ . '/view/view.api_switches.php';
		}
	}
...
new TradePress_Admin_Symbols_Page();
