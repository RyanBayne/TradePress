...
<form method="post">
    ...
    <div class="tradepress-setup-section">
        ...
        <p><em><?php esc_html_e('Note: Additional API providers can be configured later in the settings.', 'tradepress'); ?></em></p>
        
        <table class="form-table">
            <tr>
                <th scope="row"><label for="tradepress_alpaca_api_key"><?php esc_html_e('Alpaca API Key', 'tradepress'); ?></label></th>
                <td>
                    ...
                    <p class="description"><?php esc_html_e('Your Alpaca API key for trading and market data access.', 'tradepress'); ?></p>
                </td>
            </tr>
            <tr>
                <th scope="row"><label for="tradepress_alpaca_secret_key"><?php esc_html_e('Alpaca Secret Key', 'tradepress'); ?></label></th>
                <td>
                    ...
                    <p class="description"><?php esc_html_e('Your Alpaca secret key (kept secure and encrypted).', 'tradepress'); ?></p>
                </td>
            </tr>
            <tr>
                <th scope="row"><label for="tradepress_alpha_vantage_api_key"><?php esc_html_e('Alpha Vantage API Key', 'tradepress'); ?></label></th>
                <td>
                    ...
                    <p class="description"><?php esc_html_e('Your Alpha Vantage API key for market data and financial information.', 'tradepress'); ?></p>
                </td>
            </tr>
        </table>
    ...
    <div class="tradepress-disclaimer-section">
        <h2><?php esc_html_e('Important Disclaimers', 'tradepress'); ?></h2>
        
        <div style="background: #fff3cd; padding: 15px; border-left: 4px solid #ffc107; margin-bottom: 15px;">
            <h3><?php esc_html_e('No Financial Advice', 'tradepress'); ?></h3>
            <p><strong><?php esc_html_e('TradePress does NOT provide financial, investment, or trading advice.', 'tradepress'); ?></strong></p>
            <p><?php esc_html_e('All data and analysis are for informational purposes only. You are solely responsible for all trading decisions and how the plugin is configured. TradePress offers alternative approaches to exploring potential investments with no gaurantees of success. Paper trading and strict success standards is recommended before automated trading is setup.', 'tradepress'); ?></p>
        </div>
    </div>
    ...
    <p class="tradepress-setup-actions step">
        ...
        <a href="<?php echo esc_url(admin_url()); ?>" class="button button-large"><?php esc_html_e('Not right now', 'tradepress'); ?></a>
