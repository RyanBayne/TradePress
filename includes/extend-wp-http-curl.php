 ...
 *
 * @class    TradePress_Curl
 * @version  1.0
 * @package  TradePress/ Classes
 * @category Class
 * @author   Ryan Bayne
 * 
 * See extend-wp-http-curl.php for an alternative class that might replace this.
 */
...
class TradePress_Extend_WP_Http_Curl extends WP_Http_Curl {
    ...
    */
    ...
    /**
    * TradePress generates an ID for each request pre-call
    * 
    * @var mixed
    */
    public $call_id = null; 
