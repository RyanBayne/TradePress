...
class TradePress_Features_Data {
	...
	public static function get_features_data() {
		...
		$page_categories = array(
			'dashboard'         => array(
				'label' => __( 'Dashboard', 'tradepress' ),
				'url'   => admin_url( 'admin.php?page=tradepress-dashboard' ),
			),
			'settings'          => array(
				'label' => __( 'Settings', 'tradepress' ),
				'url'   => admin_url( 'admin.php?page=tradepress-settings' ),
			),
			'trading_platforms' => array(
				'label' => __( 'Trading Platforms', 'tradepress' ),
				'url'   => admin_url( 'admin.php?page=tradepress-tradingplatforms' ),
			),
			'social_platforms'  => array(
				'label' => __( 'Social Platforms', 'tradepress' ),
				'url'   => admin_url( 'admin.php?page=tradepress-social' ),
			),
			'debug'             => array(
				'label' => __( 'Debug', 'tradepress' ),
				'url'   => admin_url( 'admin.php?page=tradepress-debug' ),
			),
			'automation'        => array(
				'label' => __( 'Automation', 'tradepress' ),
				'url'   => admin_url( 'admin.php?page=tradepress-automation' ),
			),
			'research'          => array(
				'label' => __( 'Research', 'tradepress' ),
				'url'   => admin_url( 'admin.php?page=tradepress-research' ),
			),
			'sandbox'           => array(
				'label' => __( 'Sandbox', 'tradepress' ),
				'url'   => admin_url( 'admin.php?page=tradepress-sandbox' ),
			),
			'development'       => array(
				'label' => __( 'Development', 'tradepress' ),
				'url'   => admin_url( 'admin.php?page=tradepress-development' ),
			),
			'trading'           => array(
				'label' => __( 'Trading', 'tradepress' ),
				'url'   => admin_url( 'admin.php?page=tradepress-trading' ),
			),
			'watchlists'        => array(
				'label' => __( 'Watchlists', 'tradepress' ),
				'url'   => admin_url( 'admin.php?page=tradepress-watchlists' ),
			),
			'data'              => array(
				'label' => __( 'Data', 'tradepress' ),
				'url'   => admin_url( 'admin.php?page=tradepress-data' ),
			),
			'analysis'          => array(
				'label' => __( 'Analysis', 'tradepress' ),
				'url'   => admin_url( 'admin.php?page=tradepress-analysis' ),
			),
		);
