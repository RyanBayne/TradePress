...
function tradepress_get_all_system_directives() {
	return array(
		...
		'isa_reset'                   => array(
			...
			'development_status' => 'development',
			'version'            => '0.1.0',
			'tip'                => 'ISA reset creates seasonal buying pressure in UK markets (April 6th). Retail investors receive fresh £20k allowance, driving demand for popular stocks like LLOY, BP, VOD. Best used for UK-focused portfolios during March-April period.',
		),
		'isa'                         => array(
			'code'               => 'D8B',
			'name'               => __( 'ISA Season', 'tradepress' ),
			'description'        => __( 'Increases score during the broader ISA investment season (January-April)', 'tradepress' ),
			'type'               => 'bullish',
			'category'           => 'events',
			'weight'             => 10,
			'active'             => false,
			'ready'              => true,
			'bullish'            => __( 'Active during ISA season (Jan-Apr)', 'tradepress' ),
			'bearish'            => __( 'Not applicable', 'tradepress' ),
			'impact'             => 'low',
			'used_in_strategies' => false,
			'strategy_count'     => 0,
			...
			'development_status' => 'development',
			'version'            => '1.0.0',
			'tip'                => 'ISA Season captures the broader January-April period when UK investors deploy fresh ISA allowances. Wider window than ISA Reset, covering the full tax year opening period.',
		),
		'ma_crossover'                => array(
			'code'                => 'D9',
