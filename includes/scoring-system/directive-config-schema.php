	...
	public static function get_directive_fields( $directive_id ) {
		$schemas = array(
			...
			'mfi'                       => array(
				...
				'oversold_level'   => array(
					'type'    => 'int',
					'min'     => 10,
					'max'     => 30,
					'default' => 20,
				),
				'overbought_level' => array(
					'type'    => 'int',
					'min'     => 70,
					'max'     => 90,
					'default' => 80,
			...
			'support_resistance_levels' => array(
				...
				'highly_overlapped_min_methods' => array(
					'type'    => 'int',
					'min'     => 2,
					'max'     => 6,
					'default' => 4,
				),
				'well_overlapped_min_methods'   => array(
					'type'    => 'int',
					'min'     => 1,
					'max'     => 4,
					'default' => 2,
				),
				'fib_lookback_days'             => array(
					'type'    => 'int',
					'min'     => 30,
					'max'     => 500,
					'default' => 252,
				),
				'swing_lookback'                => array(
					'type'    => 'int',
					'min'     => 5,
					'max'     => 50,
					'default' => 20,
