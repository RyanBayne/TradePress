...
class TradePress_Advanced_Weekly_Rhythm_Directive extends TradePress_Base_Directive {
	...
	public function calculate_score( $symbol, $data = array() ) {
		...
		$directives = array(
			'monday_effect'        => array(
				'weight' => 0.15,
				'class'  => 'TradePress_Monday_Effect_Directive',
			),
			'friday_positioning'   => array(
				'weight' => 0.15,
				'class'  => 'TradePress_Friday_Positioning_Directive',
			),
			'volume_rhythm'        => array(
				'weight' => 0.15,
				'class'  => 'TradePress_Volume_Rhythm_Directive',
			),
			'institutional_timing' => array(
				'weight' => 0.20,
				'class'  => 'TradePress_Institutional_Timing_Directive',
			),
			'midweek_momentum'     => array(
				'weight' => 0.15,
				'class'  => 'TradePress_Midweek_Momentum_Directive',
			),
			'intraday_u_pattern'   => array(
				'weight' => 0.10,
				'class'  => 'TradePress_Intraday_U_Pattern_Directive',
			),
			'time_based_support'   => array(
				'weight' => 0.10,
				'class'  => 'TradePress_Time_Based_Support_Directive',
			),
		);
