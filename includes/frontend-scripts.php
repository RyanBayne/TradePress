<?php
/**
 * TradePress - Load Frontend Scripts
 *
...
if ( ! class_exists( 'TradePress_Frontend_Scripts' ) ) :

	/**
	 * TradePress_Frontend_Scripts Class.
	 */
	class TradePress_Frontend_Scripts {

		/**
		 * Contains an array of script handles registered by TradePress.
		 *
		 * @var array
		 */
		...
		/**
		 * Contains an array of script handles localized by TradePress.
		 *
		 * @var array
		 */
		...
		public static function get_styles() {
			return apply_filters(
				'TradePress_enqueue_styles',
				array(
					'TradePress-login' => array(
						'src'     => str_replace( array( 'http:', 'https:' ), '', TRADEPRESS_PLUGIN_URL ) . '/assets/css/TradePress-login.css',
						'deps'    => '',
		...
		public static function load_scripts() {
			...
			if ( ! did_action( 'before_TradePress_init' ) ) {
				return;
			}

			$suffix               = defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ? '' : '.min';
			$assets_path          = str_replace( array( 'http:', 'https:' ), '', TRADEPRESS_PLUGIN_URL ) . '/assets/';
			$frontend_script_path = $assets_path . 'js/frontend/';
		}

		/**
		 * Localize a TradePress script once.
		 *
		 * @access private
...
return TradePress_Frontend_Scripts::init();
