<?php
/**
 * TradePress Sortable Securities V2 Shortcode Class
 *
...
if (!class_exists('TradePress_Sortable_Securities_V2')) :

    /**
     * TradePress_Sortable_Securities_V2 Class.
     */
    class TradePress_Sortable_Securities_V2
    {
        /**
         * Constructor.
          *
        ...
        public function output()
        {
            ...
            wp_enqueue_style( 'tradepress-sortable-v2-style', plugins_url( 'sortable-securities.css', __FILE__ ) );
            wp_enqueue_script( 'jquery-ui-sortable' );
            wp_enqueue_script( 'tradepress-sortable-v2-script', plugins_url( 'ajaxloop2.js', __FILE__ ), array( 'jquery', 'jquery-ui-sortable' ), null, true );
            ...
            $output .= '<h2>Auto-Reordering Securities List V2</h2>';
