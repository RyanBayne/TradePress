...
function TradePress_display_frontend_notices_the_content( $post_content ) {
	...
	if ( ! isset( $_GET['TradePress_notice'] ) || ! is_string( $_GET['TradePress_notice'] ) ) {
		return $post_content; } elseif ( ! isset( $_GET['source'] ) || ! is_string( $_GET['source'] ) ) {
		return $post_content; } elseif ( ! isset( $_GET['key'] ) || ! is_numeric( $_GET['key'] ) ) {
			return $post_content; }
