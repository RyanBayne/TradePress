<?php
/**
 * TradePress - Small Get Functions
 *
...
* @version 1.1
*/
function TradePress_get_ip_address() {         
...
* @version 1.0
*/
function TradePress_get_users_sub_plan_name( $wp_user_id ) {
    $channel_id = TradePress_get_main_channels_twitchid();
