...
if ( ! defined( 'WP_UNINSTALL_PLUGIN' ) ) {
	wp_die( esc_html__( 'Uninstallation file incorrectly requested for the TradePress plugin.', 'tradepress' ) );
}

if ( 'yes' == get_option( 'TradePress_remove_database_tables' ) ) {
	TradePress_remove_database_tables(); }
if ( 'yes' == get_option( 'TradePress_remove_extensions' ) ) {
	TradePress_remove_extensions(); }
if ( 'yes' == get_option( 'TradePress_remove_user_data' ) ) {
	TradePress_remove_user_data(); }
if ( 'yes' == get_option( 'TradePress_remove_media' ) ) {
	TradePress_remove_media(); }
if ( 'yes' == get_option( 'TradePress_remove_roles' ) ) {
	TradePress_remove_roles(); }
...
if ( 'yes' == get_option( 'TradePress_remove_options' ) ) {
	TradePress_remove_options(); }
