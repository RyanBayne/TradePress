...
if (!extension_loaded('curl')) trigger_error('cURL is not installed on your server, please install cURL to use TradePress.');
if (!extension_loaded('json')) trigger_error('PECL JSON or pear JSON is not installed, please install either PECL JSON or compile pear JSON to use TradePress.');
        ...
        while( $final_while == false ) {
            ...
            if (strpos($this->endpoint, 'discord.com') !== false || strpos($this->endpoint, 'https://') !== false) {
                ...
                if (!isset($this->curl_request['curl_options'])) {
                    $this->curl_request['curl_options'] = [];
                }
