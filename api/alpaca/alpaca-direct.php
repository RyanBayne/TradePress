...
class TradePress_Alpaca_Direct {
	 ...
	 * @version 1.0.0
	 */
	private function build_url( $path, $query_params = array(), $version = 'v2' ) {
		$path     = trim( $path, '/' );
	 ...
	 * @version 1.0.0
	 */
	public function request( $path, $params = array(), $method = 'GET', $body = null, $version = 'v2' ) {
		// Build the URL
	 ...
	 * @version 1.0.0
	 */
	public function create_watchlist( $name, $symbols = array() ) {
		$body = array(
			'name' => $name,
		);
		...
		return $this->request( 'watchlists', array(), 'POST', $body );
	}
}
