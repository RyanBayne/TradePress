...
abstract class TradePress_Base_API extends TradePress_Financial_API_Service {
	...
	public function get_api_stats() {
		return array(
			'daily_calls' => TradePress_API_Logging::get_api_call_count(
				array(
					'service'   => $this->provider_id,
					'date_from' => date( 'Y-m-d' ),
				)
			),
			'total_calls' => TradePress_API_Logging::get_api_call_count(
				array(
					'service' => $this->provider_id,
				)
			),
			'error_calls' => TradePress_API_Logging::get_api_call_count(
				array(
					'service' => $this->provider_id,
					'status'  => 'error',
				)
