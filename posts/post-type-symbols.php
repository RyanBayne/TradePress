...
class TradePress_Post_Type_Symbols {
	...
	public static function register_post_type() {
		...
		register_post_type(
			'symbols',
			apply_filters(
				'TradePress_register_post_type_symbols',
				array(
					'labels'              => array(
					...
					'hierarchical'        => false,
					'rewrite'             => $permalinks['symbols_rewrite_slug'] ? array(
						'slug'       => $permalinks['symbols_rewrite_slug'],
						'with_front' => false,
						'symbols'    => true,
					) : false,
	...
	public static function register_post_status() {
		...
		$order_statuses = apply_filters(
			'TradePress_register_symbols_post_statuses',
			array(
