<?php
/**
 * Template Name: TradePress Symbol Template
 * Template Post Type: symbols, page
 * Description: A template for displaying security symbol details
 */
...
// Standard WordPress template classes and structure
?>

<div class="wrapper tradepress-wrapper">
    <div id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class('tradepress-symbol-container'); ?>>
                <header class="entry-header tradepress-symbol-header">
                    <?php the_title('<h1 class="entry-title symbol-title">', '</h1>'); ?>
                ...
                <div class="entry-content">
                    ...
                    <?php
                    // Add standard WordPress hooks for content
                    wp_link_pages(array(
                        'before' => '<div class="page-links">' . esc_html__('Pages:', 'tradepress'),
                        'after'  => '</div>',
                    ));
                    ?>
                ...
                <footer class="entry-footer">
                    <?php
                    // Standard WordPress entry footer
                    edit_post_link(
                        sprintf(
                            /* translators: %s: Name of current post */
                            esc_html__('Edit %s', 'tradepress'),
...
// Standard footer call - this will include the theme's footer.php file
get_footer();
?>
